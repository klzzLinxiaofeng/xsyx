...
/**
 * ExamWorksSubjectTemplate
 * @author AutoCreate
 *
 */
public class ExamWorksSubjectTemplate implements Model<Integer> {
	...
	public ExamWorksSubjectTemplate() {

	}

	public ExamWorksSubjectTemplate(Integer id) {
		this.id = id;
	}
