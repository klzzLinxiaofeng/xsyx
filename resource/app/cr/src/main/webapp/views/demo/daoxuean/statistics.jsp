            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide swiper_1">
                        <div class="pm_div">
                            <ul>
                                <li class="l1"><a href="javascript:void(0)"><p class="p1">2</p><p class="p2">年级排名</p></a></li>
                                <li class="l2"><a href="javascript:void(0)"><p class="p1">45%</p><p class="p2">年级完成率</p></a></li>
                                <li class="l3"><a href="javascript:void(0)"><p class="p1">80%</p><p class="p2">本班完成率</p></a></li>
                                <li class="l4"><a href="javascript:void(0)"><p class="p1">52</p><p class="p2">完成人数</p></a></li>
                            </ul>
                            <div class="clear"></div>
                        </div>
                        <div class="bjwcl_pmb">
                            ...
                            <div class="table_1">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td>1</td><td>初一（1）班</td><td class="f_blue">95%</td><td>45</td></tr>
                                        <tr><td>1</td><td>初一（1）班</td><td class="f_red">95%</td><td>45</td></tr>
                                        <tr><td>1</td><td>初一（1）班</td><td class="f_red">95%</td><td>45</td></tr>
                                        <tr><td>1</td><td>初一（1）班</td><td class="f_green">95%</td><td>45</td></tr>
                                        <tr><td>1</td><td>初一（1）班</td><td class="f_blue">95%</td><td>45</td></tr>
                                        <tr><td>1</td><td>初一（1）班</td><td class="f_red">95%</td><td>45</td></tr>
        ...
        <div class="mk answer-statistics">
        	<div class="as_top">
                <div class="wrapper-demo">
                    <div  class=" dd wrapper-dropdown-2" tabindex="1">试卷单元1 </div>
                    <ul class="dropdown">
                        <li>试卷单元1</li>
                        <li>试卷单元2</li>
                    </ul>
...
// 	屏幕变化各div高度
	...
	function lookHeight(){
        ...
        $(".swiper-container").css("height",swiper_height);
       	//完成情况第一个统计图高度
       	 first_height=swiper_height-214-77-120-50;
       	//完成情况table白色高度
       	 first_table=swiper_height-120-200;
       	//table最大高度
       	max_table1=Math.floor((first_table-77-50)/50)*50;
       	 max_table2=Math.floor((first_table-77-50)/50)*50;
       	//答题统计 统计图高度
	 ...
	 $.getJSON("./json/dttj.json", function (data){
		//答题统计的柱状图
		    ...
		    for(var i=0;i<k;i++){
			    ...
			    if(i==k-1){
			    	$("<div class='swiper-slide swiper_3'><div class='dt dt2' style='margin-top:0'><p>"+(k1+1)+"-"+k3+"题得分率对比图</p><div id='container_"+i+"' class='container' style='width:876px;margin: 0 auto'></div></div></div>").appendTo(".dttj_wapper")
			    }else{
			    	$("<div class='swiper-slide swiper_3'><div class='dt dt2' style='margin-top:0'><p>"+(k1+1)+"-"+k2+"题得分率对比图</p><div id='container_"+i+"' class='container' style='width:876px;margin: 0 auto'></div></div></div>").appendTo(".dttj_wapper")
			    }
			    $(".container").css("height",second_height);
