    ...
    <body>
        <div class="container-fluid">
            <jsp:include page="/views/embedded/navigation.jsp">
                ...
                <jsp:param value="上传微课" name="title" />
                        ...
                        <div class="widget-head">
                            <h3>
                                ...
                                <p style="float:right;" class="btn_link">
                                    <a class="a4" href="${pageContext.request.contextPath}/micro/myMicro?index=index"><i class="fa fa-reply"></i>返回我的微课</a>
                                </p>
                            </h3>
                        </div>
