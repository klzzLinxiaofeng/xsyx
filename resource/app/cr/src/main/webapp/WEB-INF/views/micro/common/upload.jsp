        ...
        <div class="u_wk_message">
            ...
            <div class="control-group">
                ...
                <div class="controls" style="margin-left:100px;">
                    <input type="text" name="uploadResTitle" id="uploadResTitle" value="" placeholder="微课标题" class="span5" style="width:550px;">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" style="width:80px;">
                ...
                <div class="controls" style="margin-left:100px;">
                    <textarea name="uploadMicroDescription" id="uploadMicroDescription" class="span5" style="width:550px;"></textarea>
                       ...
                       <div class="control-group" id="upload_textbook">
                <label class="control-label" style="width:80px;">
...
var catalogEnd = 0;
            ...
            function onSaveMicroSubmit() {
                ...
                var catalogTemp;
                for (var num = 2; num <= aa; num++) {
               // for (var num = aa; num >= 2; num--) {
...
//                    ca["catalog"] = textBookCatalogSelectId;
            ...
            function saveMicro() {
                if (onSaveMicroSubmit()) {
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/micro/saveOrUpdate",
                        type: "POST",
                        data: {
