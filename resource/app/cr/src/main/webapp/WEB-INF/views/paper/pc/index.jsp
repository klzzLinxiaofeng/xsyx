...
<c:choose>
	<c:when test="${not empty isPersonal }">
			<li><a href="javascript:void(0)"  onclick="changeTab('school', this)" class="a2">校本库</a></li>
			<li class="on"><a href="javascript:void(0)"  onclick="changeTab('personal', this)" class="a3">个人库</a></li>
	</c:when>
	<c:otherwise>
	...
	<div class="px_top">
		...
		<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
			...
			<jsp:param name="url" value="/paper/list?sub=pc"/>
...
var url = "/paper/list?sub=pc";

var objectType="paper";


$(function() {
	$('.dxa_list').css('min-height','595px');
