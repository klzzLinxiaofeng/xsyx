...
<div class="content_main">
	<jsp:include page="/views/embedded/plugin/subjectWidget.jsp"></jsp:include>
...
function taskModify(taskId, title) {
	 $.initWinOnTopFromLeft_qyjx("编辑 - "+title, '${pageContext.request.contextPath}/learningPlan/task/modify/view?taskId='+taskId, '553', '340');
}

function deleteTask(id) {
	var url = "${pageContext.request.contextPath}/learningPlan/task/delete/view?taskId="+id;
	 $.initWinOnTopFromLeft_qyjx("注意！", url, '513', '332');
}
