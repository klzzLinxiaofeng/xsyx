                ...
                $.ajax({
                    ...
                    success: function (mid) {
                            ...
                            if("${personType}"!='res_school'){
                            	...
                            	parent.core_iframe.location.href = "${pageContext.request.contextPath}/resource/myResource?resType=${resType}&index=index&personType=res_person&dm=${dm}";
                            	}else{
                            		parent.core_iframe.location.href = "${pageContext.request.contextPath}/resource/myResource?resType=${resType}&index=index&personType=res_school&dm=${dm}";
                            	}
                       	 $.closeWindow();
                        }
                });
