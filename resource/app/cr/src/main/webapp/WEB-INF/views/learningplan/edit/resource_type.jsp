...
<%--			<a href="javascript:void(0)" data-code="1" class='${param.resType != null && param.resType == "1" ? "on" : ""}'>微课<span><c:if test='${param.resType != null && param.resType == "1"}'>（${param.resourceCount}）</c:if></span></a> --%>
			...
			<a href="javascript:void(0)" data-code="99" class='${param.resType != null && param.resType == "99" ? "on" : ""}'>其他<span><c:if test='${param.resType != null && param.resType == "7"}'>（${param.resourceCount}）</c:if></span></a>
			<a href="javascript:void(0)" data-code="1" class='${param.resType != null && param.resType == "1" ? "on" : ""}'>微课<span><c:if test='${param.resType != null && param.resType == "1"}'>（${param.resourceCount}）</c:if></span></a>
			...
			<a href="javascript:void(0)" data-code="7" class='${param.resType != null && param.resType == "7" ? "on" : ""}'>导学案<span><c:if test='${param.resType != null && param.resType == "8"}'>（${param.resourceCount}）</c:if></span></a>
		</c:if> 
