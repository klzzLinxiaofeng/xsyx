	...
	function submitJave(entityFileUUID,httpUrl){		
		$.getJaveConversionResult({"entityFileUUID":entityFileUUID},function(data){
			...
			if(sourceJson.length == 0){
				callNormalJwplay(httpUrl, 788, 520);
				$.submitJaveSingleFile({"entityFileUUID":entityFileUUID},function(){
					
				});	
			}else{
				callJwplay(httpUrl, 788, 520, sourceJson);
			}
		});	
	};
...
<body>
	<div class="row-fluid">
		<div class="span12" style="background-color: #fff;">
			<div class="content-widgets" style="border:0;margin-bottom:0;">
				<div class="content-widgets" style="margin-bottom: 0">
					<div style="padding-left:20px;font-size:12px;line-height:30px;">
							<a href="javascript:void(0)"></a>
					</div> 
					<div class="video_div" style="margin-top:3
...
// 											var $fileUrl = "http://${pageContext.request.contextPath}:8082/develop/hnzhxy_1/2015-06/1038992-461.swf";
								...
								<c:otherwise>
								<iframe allowFullScreen="true"  id="pdfPlayer" name="pdfPlayer" src="<c:url value="/res/plugin/pdf/ROOT/web/viewer.html" />?file=<c:url value="" />" width="685" style="min-height:619px;display:none;    border: 1px solid #cdcdcd;" scrolling=no></iframe>
								<img id="download_img" src="${pageContext.request.contextPath}/res/images/not_play.jpg" style="height:380px;margin:55px auto;display:none;">
