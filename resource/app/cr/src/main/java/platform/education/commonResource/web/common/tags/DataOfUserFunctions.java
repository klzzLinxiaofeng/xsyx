...
import platform.education.commonResource.web.common.util.holder.UserModuleServiceHolder;
...
public class DataOfUserFunctions {
	...
	private final static TeacherService teacherService = UserModuleServiceHolder.getInstance().getTeacherService();
