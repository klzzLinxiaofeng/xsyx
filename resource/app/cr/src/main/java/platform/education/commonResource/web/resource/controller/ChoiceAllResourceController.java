...
public class ChoiceAllResourceController {
	@Autowired
	...
	public String process(){
		...
		for(ResourceLibrary rl : list){
			 ...
			 * 小学语文科目
			 */
			System.out.println("资源统计小学语文科目开始");
			...
			System.out.println("资源统计小学语文科目结束");
			/**
			 * 初中语文科目
			 */
			 ...
			 * 初中英语科目
			 */
			System.out.println("资源初中英语科目统计开始");
