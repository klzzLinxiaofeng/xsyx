package platform.education.commonResource.web.common.shiro.utils;
...
import platform.education.commonResource.web.common.shiro.code.CrRedirectView;
...
public class WebUtils {
    ...
    public static void issueRedirect(ServletRequest request, ServletResponse response, String url, Map queryParams, boolean contextRelative, boolean http10Compatible) throws IOException {
        CrRedirectView view = new CrRedirectView(url, contextRelative, http10Compatible);
