...
public class CeshiController {
    ...
    public static void main(String[] args) {
        String ip = PropertiesUtil.getProperty("application.properties", "canteen.server.address");
        String addres = PropertiesUtil.getProperty("application.properties", "canteen.user.list.url");
        ...
        try {
            ...
            if (BaseConstant.SUCCESS.getMesg().equals(httpRequestResult.getCode())) {
                ...
                if (!StrUtil.hasEmpty(responseText)) {
                    ...
                    String title_name = jsonObject.getString("result");
                   Object o=jsonObject.get("data");
                    System.out.println("statusCode" + statusCode + "=-----result" + o.toString()+ "-------title_name" + title_name);
                }
            }/*
