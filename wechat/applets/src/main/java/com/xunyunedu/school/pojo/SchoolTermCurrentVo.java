package com.xunyunedu.school.pojo;
 ...
 * @Description:
 */
public class SchoolTermCurrentVo implements Serializable {
    ...
    public SchoolTermCurrentVo() {

    }

    public SchoolTermCurrentVo(Integer id) {
        this.id = id;
    }
