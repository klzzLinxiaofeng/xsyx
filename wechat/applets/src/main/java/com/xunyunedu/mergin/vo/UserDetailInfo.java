...
public class UserDetailInfo implements Model<Integer>{
    ...
    private List<platform.education.generalTeachingAffair.model.Parent> parentList;
    ...
    public List<platform.education.generalTeachingAffair.model.Parent> getParentList() {
        return parentList;
    }
