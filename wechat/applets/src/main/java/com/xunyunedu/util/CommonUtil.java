...
public class CommonUtil {
	 ...
	 * @param List<TeacherPojo>
	 * @return List<Teacher>
	 */
	public static List<TeacherPojo> distinctTeacherOfUserId(List<TeacherPojo> tList){
		List<TeacherPojo> list = new ArrayList<TeacherPojo>();
		for(int i=0;i<tList.size();i++){
			boolean flag = true;
			for(TeacherPojo t2 : list){
	 ...
	 * @return List<Teacher>
	 */
	public static List<TeacherPojo> distinctTeacherOfTeacherId(List<TeacherPojo> tList){
		List<TeacherPojo> list = new ArrayList<TeacherPojo>();
		for(int i=0;i<tList.size();i++){
			boolean flag = true;
			for(TeacherPojo t2 : list){
	 ...
	 */
	public static List<PjDepartmentTeacher> distinctDepartmentTeacherOfTeacherId(List<PjDepartmentTeacher> tList){
		List<PjDepartmentTeacher> list = new ArrayList<PjDepartmentTeacher>();
		for(int i=0;i<tList.size();i++){
			boolean flag = true;
			for(PjDepartmentTeacher t2 : list){
