...
public class IndicatorsStudent {
    ...
    List<IndicatorsPojo> list=new ArrayList<>();
    /*
     * 请假天数
     */
    ...
    public List<IndicatorsPojo> getList() {
        return list;
    }

    public void setList(List<IndicatorsPojo> list) {
        this.list = list;
    }
