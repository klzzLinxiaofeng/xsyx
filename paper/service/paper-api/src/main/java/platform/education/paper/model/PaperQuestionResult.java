...
*  
*/
public class PaperQuestionResult implements Serializable{
	...
	//题目选项
	private String[] webQuestionAnswer;
	...
	//标准答案
	private String []webCorrectAnswer;
	...
	public String[] getWebQuestionAnswer() {
		return webQuestionAnswer;
	}

	public void setWebQuestionAnswer(String[] webQuestionAnswer) {
		this.webQuestionAnswer = webQuestionAnswer;
	}

	public String[] getWebCorrectAnswer() {
		return webCorrectAnswer;
	}

	public void setWebCorrectAnswer(String[] webCorrectAnswer) {
		this.webCorrectAnswer = webCorrectAnswer;
	}
}
