...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/udemy-blessed3_css.css" />
<title>浏览器下载</title>
<style>
	body{
...
<body style="background-color:#fff;">
	...
	<div id="big-logo">
			...
			<img class="old" src="${pageContext.request.contextPath}/css/images/old.jpg">
			</div>
		<div class="container" id="upgrade-browser">
			...
			<a class="br4" href="http://windows.microsoft.com/zh-CN/internet-explorer/download-ie">IE 9/10</a>
			</div>
		</div>
	</div>
</body>
