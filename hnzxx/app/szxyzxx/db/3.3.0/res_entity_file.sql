...
CREATE TABLE `res_entity_file` (
  ...
  `content_type` varchar(45) NOT NULL DEFAULT '' COMMENT '文件头类型 ',
  `file_name` varchar(255) NOT NULL COMMENT '真实文件名',
  `disk_file_name` varchar(255) NOT NULL COMMENT '系统磁盘上的文件名称',
  `thumbnail_url` varchar(1000) NOT NULL DEFAULT '' COMMENT '文件对应缩略图的相对地址',
  `relative_path` varchar(1000) NOT NULL COMMENT '文件的相对路径',
  `create_date` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=61080 DEFAULT CHARSET=utf8;
