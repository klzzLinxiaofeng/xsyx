...
ALTER TABLE `jc_textbook` 
CHANGE COLUMN `isbn` `isbn` VARCHAR(20) NULL COMMENT 'isbn 国际标准书号（International Standard Book Number），简称ISBN，是专门为识别图书等文献而设计的国际编号' ,
CHANGE COLUMN `publish_date` `publish_date` DATETIME NULL COMMENT '出版日期' ;

ALTER TABLE `jc_textbook` 
CHANGE COLUMN `volumn` `volumn` VARCHAR(2) NOT NULL COMMENT '册次，卷' ;
