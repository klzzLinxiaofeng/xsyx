...
public class ClientTeamMessageForGrade {
...
//	List<FilesVo>fileList;
	...
	public ClientTeamMessageForGrade() {

	}
	
	public ClientTeamMessageForGrade(TeamMessage teamMessage,String files) {
		...
		this.gradeId = teamMessage.getReceiverId();
		this.gradeName = teamMessage.getReceiverName();
