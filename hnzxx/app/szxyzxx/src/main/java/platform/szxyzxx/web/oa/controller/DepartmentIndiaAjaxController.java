...
@Controller
@RequestMapping(value = "/office/ajax/departmentIndia")
public class DepartmentIndiaAjaxController extends BaseController{
	...
	@RequestMapping(value = "/departmentIndia_index")
	public ModelAndView departmentIndia_index(@CurrentUser UserInfo user,
		...
		if ("departmentIndia_list".equals(sub)) {
			viewPath = structurePath("/departmentIndia_list");
		} else {
			viewPath = structurePath("/departmentIndia_index");
		}
