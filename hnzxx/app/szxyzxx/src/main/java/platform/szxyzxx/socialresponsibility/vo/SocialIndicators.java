...
public class SocialIndicators {
    ...
    */
    ...
    public SocialIndicators(){}

    public SocialIndicators(Integer id, String name, Integer score, Date createTime, Date modiyTime, Integer isDelete, String schoolYear, String schoolTrem) {
        this.id = id;
        this.name = name;
        this.score = score;
