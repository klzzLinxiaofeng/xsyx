 ...
 */
public class ClassApiUnsetClassMasterParam extends OpenApiParam {
    ...
    public static ClassApiUnsetClassMasterParamBuilder builder(){
        return new ClassApiUnsetClassMasterParamBuilder();
    }

    public static class ClassApiUnsetClassMasterParamBuilder{
        private JSONRequestBody requestBody;

        public ClassApiUnsetClassMasterParamBuilder requestBody(JSONRequestBody requestBody){
            this.requestBody = requestBody;
            return this;
        }

        public ClassApiUnsetClassMasterParam build(){
