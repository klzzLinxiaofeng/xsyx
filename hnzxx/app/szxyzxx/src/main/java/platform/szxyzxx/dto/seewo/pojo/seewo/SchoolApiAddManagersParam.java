 ...
 */
public class SchoolApiAddManagersParam extends OpenApiParam {
    ...
    public static SchoolApiAddManagersParamBuilder builder(){
        return new SchoolApiAddManagersParamBuilder();
    }

    public static class SchoolApiAddManagersParamBuilder{
        private JSONRequestBody requestBody;

        public SchoolApiAddManagersParamBuilder requestBody(JSONRequestBody requestBody){
            this.requestBody = requestBody;
            return this;
        }

        public SchoolApiAddManagersParam build(){
