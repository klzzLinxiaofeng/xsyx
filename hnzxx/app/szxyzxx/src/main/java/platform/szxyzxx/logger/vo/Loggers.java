package platform.szxyzxx.logger.vo;
...
public class Loggers {
   ...
   private String schoolTrem;
    ...
    public Loggers(Integer id, Integer caozuoId, String name, String username, String mobile, Date createTime, String createTime2, Date modiyTme, String mokuaiName, Integer type, String typeName, Integer isDelete, String message, String schoolYear, String schoolTrem) {
        this.id = id;
