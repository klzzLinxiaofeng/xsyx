 ...
 */
public class CardApiGetUserByCardIdParam extends OpenApiParam {
    ...
    public static CardApiGetUserByCardIdParamBuilder builder(){
        return new CardApiGetUserByCardIdParamBuilder();
    }

    public static class CardApiGetUserByCardIdParamBuilder{
        private JSONRequestBody requestBody;

        public CardApiGetUserByCardIdParamBuilder requestBody(JSONRequestBody requestBody){
            this.requestBody = requestBody;
            return this;
        }

        public CardApiGetUserByCardIdParam build(){
            CardApiGetUserByCardIdParam param = new CardApiGetUserByCardIdParam();
