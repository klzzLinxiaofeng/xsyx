...
public class ClientTeamMessageForTeam {
...
//	List<FilesVo>fileList;
	...
	public ClientTeamMessageForTeam() {

	}
	
	
	public ClientTeamMessageForTeam(TeamMessage teamMessage,String files) {
		...
		this.teamId = teamMessage.getReceiverId();
		this.teamName = teamMessage.getReceiverName();
