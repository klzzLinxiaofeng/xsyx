...
public class LiteracyVo {
    ...
    */
    ...
    public LiteracyVo(Integer id, String xn, String xq, Integer gradeId, String gradeName, Integer subjectId, String subjectName, String literacyName, Integer score, Date createTime, Date moideTime, Integer isDelete) {
        this.id = id;
        this.xn = xn;
        this.xq = xq;
