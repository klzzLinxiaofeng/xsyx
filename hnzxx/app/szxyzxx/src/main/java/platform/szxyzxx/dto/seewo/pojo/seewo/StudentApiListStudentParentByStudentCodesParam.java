 ...
 */
public class StudentApiListStudentParentByStudentCodesParam extends OpenApiParam {
    ...
    public static StudentApiListStudentParentByStudentCodesParamBuilder builder(){
        return new StudentApiListStudentParentByStudentCodesParamBuilder();
    }

    public static class StudentApiListStudentParentByStudentCodesParamBuilder{
        private JSONRequestBody requestBody;

        public StudentApiListStudentParentByStudentCodesParamBuilder requestBody(JSONRequestBody requestBody){
            this.requestBody = requestBody;
            return this;
        }

        public StudentApiListStudentParentByStudentCodesParam build(){
