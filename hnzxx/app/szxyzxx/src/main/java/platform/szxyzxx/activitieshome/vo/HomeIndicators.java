...
public class HomeIndicators {
    ...
    */
    ...
    public HomeIndicators(){}

    public HomeIndicators(Integer id, String name, Integer score, Date createTime, Date modiyTime, Integer isDelete, String schoolYear, String schoolTrem) {
        this.id = id;
        this.name = name;
        this.score = score;
