package platform.szxyzxx.warehousing.vo;
...
public class WareHousing {
    ...
    */
    ...
    @ExcelColumnExport("物资类型")
    private String typeName;
    /*
     * 物资名称
     */
    @ExcelColumnImport(index =4)
    @ExcelColumnExport("物资名称")
    private String name;
    /*
     * 备注
     */
