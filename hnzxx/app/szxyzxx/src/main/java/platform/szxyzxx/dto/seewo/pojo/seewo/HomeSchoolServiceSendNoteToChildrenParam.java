 ...
 */
public class HomeSchoolServiceSendNoteToChildrenParam extends OpenApiParam {
    ...
    public static HomeSchoolServiceSendNoteToChildrenParamBuilder builder(){
        return new HomeSchoolServiceSendNoteToChildrenParamBuilder();
    }

    public static class HomeSchoolServiceSendNoteToChildrenParamBuilder{
        private RequestBody requestBody;

        public HomeSchoolServiceSendNoteToChildrenParamBuilder requestBody(RequestBody requestBody){
            this.requestBody = requestBody;
            return this;
        }

        public HomeSchoolServiceSendNoteToChildrenParam build(){
