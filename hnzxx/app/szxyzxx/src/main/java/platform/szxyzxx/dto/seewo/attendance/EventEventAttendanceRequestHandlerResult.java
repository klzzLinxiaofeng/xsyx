 ...
 */
public class EventEventAttendanceRequestHandlerResult extends OpenApiResult {

    public EventEventAttendanceRequestHandlerResult(HttpResponse response) {
        super(response);
    }
    ...
    public static class JSONResponseBody {
         ...
         * 返回业务数据
         */
        private List<AttendanceEventRecordResult> data;
        ...
        public List<AttendanceEventRecordResult> getData() {
            return this.data;
        }

        public void setData(List<AttendanceEventRecordResult> data) {
            this.data = data;
        }

    }

    public static class AttendanceEventRecordResult {
        /**
         * 事件ID
         */
