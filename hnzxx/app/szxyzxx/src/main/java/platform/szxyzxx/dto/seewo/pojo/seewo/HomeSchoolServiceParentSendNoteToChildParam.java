 ...
 */
public class HomeSchoolServiceParentSendNoteToChildParam extends OpenApiParam {
    ...
    public static HomeSchoolServiceParentSendNoteToChildParamBuilder builder(){
        return new HomeSchoolServiceParentSendNoteToChildParamBuilder();
    }

    public static class HomeSchoolServiceParentSendNoteToChildParamBuilder{
        private RequestBody requestBody;

        public HomeSchoolServiceParentSendNoteToChildParamBuilder requestBody(RequestBody requestBody){
            this.requestBody = requestBody;
            return this;
        }

        public HomeSchoolServiceParentSendNoteToChildParam build(){
