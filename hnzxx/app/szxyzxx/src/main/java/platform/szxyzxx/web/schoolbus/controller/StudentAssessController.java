 ...
 * @Description: 学生评价和学生表现一样逻辑
 */
@Controller
@RequestMapping("/student/assess")
public class StudentAssessController {
    private final static String viewBasePath = "/student/student_assess";
    ...
    public String delRelaseShow(Integer id) {
        studentAssessService.delete(id);
    ...
    public StuVo json(
        ...
        List<PerformancePojo> list = studentAssessService.findSutBusByGroupCondition(performancePojo, page);
