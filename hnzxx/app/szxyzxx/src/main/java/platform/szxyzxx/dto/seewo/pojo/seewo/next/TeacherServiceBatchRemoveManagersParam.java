 ...
 */
public class TeacherServiceBatchRemoveManagersParam extends OpenApiParam {
    ...
    public static TeacherServiceBatchRemoveManagersParamBuilder builder(){
        return new TeacherServiceBatchRemoveManagersParamBuilder();
    }

    public static class TeacherServiceBatchRemoveManagersParamBuilder{
        private RequestBody requestBody;

        public TeacherServiceBatchRemoveManagersParamBuilder requestBody(RequestBody requestBody){
            this.requestBody = requestBody;
            return this;
        }

        public TeacherServiceBatchRemoveManagersParam build(){
