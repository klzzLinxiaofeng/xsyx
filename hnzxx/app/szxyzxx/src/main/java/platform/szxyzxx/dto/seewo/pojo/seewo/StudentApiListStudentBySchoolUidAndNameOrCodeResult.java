 ...
 */
public class StudentApiListStudentBySchoolUidAndNameOrCodeResult extends OpenApiResult {

    public StudentApiListStudentBySchoolUidAndNameOrCodeResult(HttpResponse response) {
        super(response);
    }
