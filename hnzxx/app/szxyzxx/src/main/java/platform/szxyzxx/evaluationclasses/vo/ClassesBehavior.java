...
public class ClassesBehavior {
    ...
    List<ClassesIndicators> lifeIndicatorsList;
    public ClassesBehavior(){}

    public ClassesBehavior(Integer id, Integer studentId, String studentName, String teamName, Integer classesIndicatorsId, String classesIndicatorsName, Date createTime, Date modiyTime, Integer isDelete, String schoolYear, String schoolTrem, Integer fenshu, String pingyu, String teacherName, List<ClassesIndicators> lifeIndicatorsList) {
        this.id = id;
    ...
    public List<ClassesIndicators> getLifeIndicatorsList() {
        return lifeIndicatorsList;
    }

    public void setLifeIndicatorsList(List<ClassesIndicators> lifeIndicatorsList) {
        this.lifeIndicatorsList = lifeIndicatorsList;
    }
