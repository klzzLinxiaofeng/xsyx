...
function(a) {
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        init: function() {
            ...
            if (b.isDynamic = "audio" !== e && "video" !== e, b.isDynamic ? b.isVideo = b.options.isVideo: b.isVideo = "audio" !== e && b.options.isVideo, c.isiPad && b.options.iPadUseNativeControls || c.isiPhone && b.options.iPhoneUseNativeControls) b.$media.attr("controls", "controls"),
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildcurrent: function(b, c, d, e) {
            var f = this;
            a('<div class="mejs-time" role="timer" aria-live="off"><span class="mejs-currenttime" style="display:none">' + mejs.Utility.secondsToTimeCode(0, b.options) + "</span></div>").appendTo(c),
        ...
        updateCurrent: function() {
            ...
            a.currenttime && a.currenttime.html(a.media.currentTime)
        },
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildspeed: function(b, c, d, e) {
            ...
            if ("native" == f.media.pluginType) {
                ...
                for (m = 0, il = k.length; m < il; m++) j = f.id + "-speed-" + k[m].value,
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildpostroll: function(b, c, d, e) {
            ...
            "undefined" != typeof g && (b.postroll = a('<div class="mejs-postroll-layer mejs-layer"><a class="mejs-postroll-close" onclick="$(this).parent().hide();return false;">' + f.options.postrollCloseText + '</a><div class="mejs-postroll-layer-content"></div></div>').prependTo(d).hide(), f.media.addEventListener("ended",
            function(c) {
                a.ajax({
                    dataType: "html",
                    url: g,
