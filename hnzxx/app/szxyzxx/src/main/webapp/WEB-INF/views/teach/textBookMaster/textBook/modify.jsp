...
<div class="container-fluid">
					...
					<div class="class_detail">
						<form class="form-horizontal tan_form" id="jctextbook_form" action="javascript:void(0);">
							...
							<div class="control-group">
								...
								placeholder="出版日期" value='<fmt:formatDate pattern="yyyy-MM-dd" value="${jcTextbook.publishDate}"/>' onclick="WdatePicker()" style="width:220px;">
								</div>
							...
							<div class="control-group">
								...
								<textarea  rows="3"  id="writerDescription" name="writerDescription" class="span13"
									placeholder=""style="width:450px;height:200px;">${jcTextbook.writerDescription} </textarea>
								</div>
	...
	<%-- <div class="row-fluid">
		<div class="span12">
			...
			<div>
				<a href="${ctp}/teach/textBookMaster/textBook/index" >图书列表</a>
			    <a href="" id="loadViewerPage"  onclick="loadViewerPage('${jcTextbook.id}');">基本信息</a>
				<a href=""  id="loadViewerCatalogPage"  onclick="loadViewerCatalogPage('${jcTextbook.id}');">教材目录</a>
...
<script type="text/javascript">
				...
				if("success" === status) {
					...
					if("success" === data.info) {
						if(parent.core_iframe != null) {
							window.location.href="${ctp}/teach/textBookMaster/textBook/viewer?id=${jcTextbook.id}";
 						} else {
 							window.location.href="${ctp}/teach/textBookMaster/textBook/viewer?id=${jcTextbook.id}";
 						}
						$.closeWindow();
	...
	function textBookVersion() {
		 ...
		 $("#version").empty();
		 var versionId ='${jcTextbook.version}';
		 ...
		 $.ajax({  
			...
			$.each(map,function(key,values){
				 if(${jcTextbook.version != ''}&&${jcTextbook.version != undefined}&&(versionId == values)){
	...
	function textBookPublish() {
		 ...
		 $("#publisherId").empty();
		var publishId ='${jcTextbook.publisherId}';
		 ...
		 $.ajax({  
			...
			$.each(map,function(key,values){
			   if(${jcTextbook.publisherId != ''}&&${jcTextbook.publisherId != undefined}&&(publishId == values)){
