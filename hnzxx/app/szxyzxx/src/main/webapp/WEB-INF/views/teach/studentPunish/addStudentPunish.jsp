						...
						<div class="form-container">
							...
							<div class="control-group">
								...
								<input type="text" id="punishType" name="punishType" class="span13"
									placeholder="处分类型，小于20个字" value="${studentPunish.punishType}" style="width:220px;"/>
								</div>
							...
							<div class="control-group">
								...
								<div class="controls">
								<%--  <input type="text" id="punishEndDay" name="punishEndDay" class="span13" placeholder="到期日期" 
								 value='<fmt:formatDate pattern="yyyy-MM-dd" value='${studentPunish.punishEndDay}'></fmt:formatDate>'  
								 onclick="WdatePicker()"  style="width:220px;"/>
								  --%>
								 	<input type="text"  style="width:220px;"  id="punishEndDay" name="punishEndDay" class="span13"
							...
							<div class="clear"></div>
								...
								<button  onclick="saveUserInfo();" class="btn btn-warning"  type="button" >保存</button>
						</div>
							</form>
						</div>
					</div>
...
var checker;
	...
	$(function() {
		...
		//违纪类别
		$.jcGcSelector("#punishCause", {tc : "JY-WJLB"}, "", function() {
			$("#punishCause").chosen();
		});
