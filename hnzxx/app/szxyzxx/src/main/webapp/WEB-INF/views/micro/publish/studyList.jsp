...
<html>
                ...
                <c:forEach var="micro" items="${microList}">
                    <div class="xs_wk white">
                        <div class="xs_left">
                            ...
                            <a href="${pageContext.request.contextPath}/micropublish/play?microPublishedId=${micro.publishMicroLessonId}&publisherId=${micro.publisherId}" class="start_study">开始学习</a>
                        </div>
                        <div class="xs_right">
                            <ul>
    ...
    <script type="text/javascript">
        $(function(){
           var url="${pageContext.request.contextPath}/micropublish/ajaxGetStudyJson";
