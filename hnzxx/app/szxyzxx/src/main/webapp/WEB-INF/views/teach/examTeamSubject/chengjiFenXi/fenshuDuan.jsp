            ...
            <div class="widget-head">
                <h3>
                    ...
                    <p class="btn_link" style="float: right;">
                        ...
                        <a id="downLoadExcel"  class="a2" href="#" onclick="daochu();" class="a2" >导出分数段分析</a>
                    </p>
                </h3>
            </div>
            ...
            <div class="content-widgets">
                <div class="widget-container">
                    <div class="select_b">
                        ...
                        <div class="clear">
                            <span>评分标准：A++(等于100)、A+(95-99)、A(85-94)、B(75-84)、C(60-74)、D(小于60)</span>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function () {
        initSelect();
        var strs='<thead><tr role="row"><th>考试名称</th><th>班级名称</th><th>班级人数</th><th>参考人数</th><th>总分</th><th>平均分</th><th>A++</th><th>A+</th><th>A</th><th>B</th><th>C</th><th>D</th><th>任课教师</th></tr></thead><tbody id="publicClass_list_content"></tbody>';
                ...
                if(xl!=null && xl !=""){
                        ...
                        if (km != null && km != "") {
                            ...
                            if(xl==4) {
                                ...
                                var url = "/scoreFenXi/findByFenShuDuanFenXi";
                                $.post(url,val,function (d) {
                                    var dd=JSON.parse(d);
                                    var strs="<thead><tr role='row'><th>考试名称</th><th>班级名称</th><th>班级人数</th><th>参考人数</th><th>总分</th><th>平均分</th><th>A++</th><th>A+</th><th>A</th><th>B</th><th>C</th><th>D</th><th>任课教师</th></tr></thead><tbody id= 'publicClass_list_content'>";
                                    for(var a=0;a<dd.length;a++){
                                        strs+="<tr><td>"+dd[a].examName+"</td><td>"+dd[a].teamName+"</td><td>"+dd[a].teamSize+"</td><td>"+dd[a].cankao+"</td><td>"+dd[a].zongfen+"</td><td>"+dd[a].svg+"</td><td>"+dd[a].A2+"</td><td>"+dd[a].A1+"</td><td>"+dd[a].A+"</td><td>"+dd[a].B+"</td><td>"+dd[a].C+"</td><td>"+dd[a].D+"</td><td>"+dd[a].teacher+"</td></tr>";
                                    }
                                    strs+="</tbody>";
                                    $("#data-table").html("");
                                    $("#data-table").append(strs);
    ...
    function daochu() {
        var url = "/scoreFenXi/daochuFenShuDuan";
        var nj = $("#nj").val();
        var xn = $("#xn").val();
        var xq = $("#xq").val();
        var km =$("#km").val();
