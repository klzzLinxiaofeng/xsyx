...
<body>
	<div class="container-fluid">
		<jsp:include page="/views/embedded/navigation.jsp">
			...
			<jsp:param value="资源播放" name="title" />
...
<!-- 										<img src="http://127.0.0.1:8082/develop/hnzhxy_1/2015-06/c5af5ea430880e954a37677b2e414d03.jpg" style="margin:0 auto;max-width:786px;max-height:619px;display:block"> -->
									...
									<c:otherwise>
										...
										<a onclick="downloadRes('${eurlFn:convertUrl(entity.relativePath)}')" href="javascript:void(0)" class="download"></a>
									</c:otherwise>
								</c:choose>
								</div>
							</div>
							<div class="v_div">
								<div class="fx_left">
									<div class="fx_1">
										<a href="javascript:void(0)" class="a1" onclick="fav('${res.resEnt.uuid}', '<%=ResourceType.EXAM%>', '${res.resEnt.title}');">收藏资源</a> 
										<a href="javascript:void(0)" class="a3" onclick="like('${res.resEnt.uuid}', '<%=ResourceType.EXAM%>', '${res.resEnt.title}', this)"></a>
                                                                                <a onclick="downloadRes('${eurlFn:convertUrl(entity.relativePath)}')" href="javascript:void(0)" class="a2">下载</a>
									</div>
									<div class="fx_2">
...
<script type="text/javascript">
	...
	function fav(resId, resType, title) {
		var requestData = {"resType" : resType, "resId" : resId, "title" : title, "isFav" : true};
	...
	function like(resId, resType, title, obj) {
// 		alert(resId + "_" + resType + "_" + title);
		var requestData = {"resType" : resType, "resId" : resId, "title" : title, "isLike" : true};
