    ...
    <tbody id="module_list_content">
        ...
        <c:forEach items="${mlrList}" var="micro">
            <tr>
                ...
                <td class="caozuo">
                    <a href="${pageContext.request.contextPath}/homeworkpublish/publishDetails?index=index&microPublishedId=${micro.publishMicroLessonId}&relateId=${micro.relateId}&relateType=${relateType}">查看详情</a>
