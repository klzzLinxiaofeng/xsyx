							...
							<table class="table table-bordered" id="table1">
								...
								<c:forEach items="${taskItemList}"  var="taskItem">
									<tr class="taskItem" id="${taskItem.id }" id="trid">
										...
										<td class="score"><input type="hidden" value="${taskItem.startScore };${taskItem.endScore }"><input id="score" disabled="disabled" type="text" value=""></td>
										<td><input id="remark" disabled="disabled" type="text" style="width:270px;"> </td>
									</tr>
								</c:forEach>
...
<!-- 								<button class="btn btn-warning" type="button" onclick="exit();"></button> -->
<%-- 							</c:if> --%>
						</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(".score input").blur(function(){
		...
		var start_score = parseInt(score_range[0]);
		var end_score = parseInt(score_range[1]);
