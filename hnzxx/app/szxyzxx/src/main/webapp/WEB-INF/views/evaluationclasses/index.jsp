                ...
                <div class="content-widgets">
                    ...
                    <div class="widget-container">
                        ...
                        <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                            ...
                            <jsp:param name="url" value="/classesIndicator/findByAll?sub=list"/>
...
<script type="text/javascript">
    ...
    function delMore() {
        ...
        if (checked != null && checked.length > 0) {
            ...
            requestData.ids = ids;
            var idss = ids.join(",");
            $.post("${ctp}/classesIndicator/delete", {ids: idss}, function (data, status) {
                if ("success" === status) {
                    if ("success" === data) {
                        $.success("删除成功");
    ...
    function executeDel(obj, id) {
        $.post("${ctp}/classesIndicator/delete", {ids: id}, function (data, status) {
            if ("success" === status) {
                if ("success" === data) {
                    $.success("删除成功");
                    $("#" + id + "_tr").remove();
    ...
    function loadEditPage(id) {
        $.initWinOnTopFromLeft('编辑', '${ctp}/classesIndicator/addOrupdateView?id=' + id, '800', '450');
    }


    // 	加载创建对话框
    function loadCreatePage() {
        $.initWinOnTopFromLeft('添加', '${ctp}/classesIndicator/addOrupdateView', '800', '450');
    }
