            ...
            <div class="content-widgets">
                <div class="widget-container">
                    ...
                    <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                        ...
                        <jsp:param name="url" value="/practice/innovation/chakan?sub=list&studentId=${studentId}"/>
...
<script type="text/javascript">
    ...
    function search() {
        ...
        var xn = $("#xn").val();
        var xq = $("#xq").val();
        var url = "/practice/innovation/chakan?sub=list";
    ...
    function add(id) {
        $.initWinOnTopFromLeft('添加实践创新','/practice/innovation/innovation/input?studentId='+id,'1000','550')
    }
    //绑定下拉框改变事件
    $("#xn").change(function(){
        $("#xq").html('');
    ...
    function bianji(id){
        $.initWinOnTopFromLeft('编辑', '/practice/innovation/innovation/inputOrchakan?sub=inputs&id='+id, '1000', '550');
    }
    function chakan(id){
        $.initWinOnTopFromLeft('详情', '/practice/innovation/innovation/inputOrchakan?sub=chakan&id='+id, '1000', '550');
    }
</script>
</body>
