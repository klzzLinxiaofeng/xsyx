...
<!DOCTYPE html>
    <c:forEach var="ms" items="${microList}">
        <li>
            <a href="${pageContext.request.contextPath}/exampublish/play?study=study&objId=${ms.resEnt.exam.id}&microPublishedId=${microPublishId}&publisherId=${param.publisherId}">
            ...
            <p class="de_2">${ms.resEnt.exam.title}</p>
