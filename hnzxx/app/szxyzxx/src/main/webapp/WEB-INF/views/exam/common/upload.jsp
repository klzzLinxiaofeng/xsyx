...
//                    ca["catalog"] = textBookCatalogSelectId;
            ...
            function saveMicro() {
                if (onSaveMicroSubmit()) {
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/examhouse/saveOrUpdate",
                        type: "POST",
                        data: {
                        ...
                        success: function(data) {
                            ...
                            if ("publish" == "${publish}") {
                                ...
                                addMicro(data.objectId, $("#uploadResTitle").val(),data.id);
                                setSize();
                                removeUploadMicro();
                            } else {
                                //上传时的操作
                                $.alert("上传成功");
                                location.href = "${pageContext.request.contextPath}/examhouse/myExam?index=index";
                            }
                        }
                    });
                }
