        ...
        <script type="text/javascript">
            ...
            function save() {
                if ($('#dateForm').valid()) {
                    ...
                    var url = "${pageContext.request.contextPath}/homeworkpublish/updatePublishedDate";
                    loader.show();
                    $.post(url, $requestData, function (data, status) {
                        if ("success" === status) {
                            $.alert("修改作业布置时间成功");
                            var reurl = "${pageContext.request.contextPath}/homeworkpublish/publishManagerIndex/?relateId=" + $requestData.relateId;
