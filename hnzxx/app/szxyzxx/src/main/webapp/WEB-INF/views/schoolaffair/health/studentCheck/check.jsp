...
<body style="background-color: #fff !important">
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="widget-head" style="margin:5px 20px 0;"><h3>晨检症状<p class="btn_link" style="float: right;">
			<c:choose>
...
function loadCreatePage(studentId, teamId) {
	$.initWinOnCurFromLeft('添加记录', '${ctp}/schoolaffair/healthStudentCheck/add?studentId=' + studentId + '&teamId=' + teamId, '600', '250');
}

//加载编辑对话框
function loadEditPage(id) {
	$.initWinOnCurFromLeft('编辑', '${ctp}/schoolaffair/healthStudentCheck/editor?id=' + id, '600', '250');
}
...
function executeDel(obj, id) {
	$.post("${ctp}/schoolaffair/healthStudentCheck/" + id, {"_method" : "delete"}, function(data, status) {
		if ("success" === status) {
			if ("success" === data) {
				$.success("删除成功");
				$("#" + id + "_tr").remove();
