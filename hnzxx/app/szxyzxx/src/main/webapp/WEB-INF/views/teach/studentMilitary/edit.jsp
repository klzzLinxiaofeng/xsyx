				...
				<div class="widget-container" style="padding: 20px 0 0;">
					<form class="form-horizontal tan_form" id="studentmilitary_form" action="javascript:void(0);">
							...
							<div class="control-group">
								...
								<div class="controls">
								<p class="p_right">${studentMilitary.studentNumber}</p>
<%-- 								<input type="text" id="studentNumber" name="studentNumber" class="span13" placeholder="" value="${studentMilitary.studentNumber}"> --%>
							...
							<div class="control-group">
								...
								<div class="controls">
								<p class="p_right">${studentMilitary.name}</p>
							...
							<div class="control-group">
								...
								<div class="controls">
								<p class="p_right">${studentMilitary.teamName}</p>
							...
							<div class="control-group">
								...
								<div class="controls">
								<p class="p_right">${studentMilitary.number}</p>
