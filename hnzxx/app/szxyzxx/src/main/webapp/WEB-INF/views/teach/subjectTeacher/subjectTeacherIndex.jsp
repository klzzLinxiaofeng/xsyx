...
<body>
	<div class="container-fluid">
		<jsp:include page="/views/embedded/navigation.jsp">
			...
			<jsp:param value="科任教师管理" name="title" />
							...
							<div class="clear"></div>
								...
								<div class="widget-container" id="code_Nation"
									...
									<div class="widget-head" style="border-bottom: 0 none;">
										<h3 id="krTeacher">
											...
											<p style="float: right; margin-bottom: 3px;" class="btn_link">
												...
												<a class="a4" href="javascript:void(0)"
													onclick="loadCreateSubjectTeacherPage();"><i
													class="fa fa-plus"></i>新增科任教师</a>
											</p>
										</h3>
									</div>
									...
									<jsp:include page="/views/embedded/jqpagination.jsp"
										...
										<jsp:param name="url"
											value="/teach/subjectTeacher/getSubjectTeacherList?sub=list" />
