...
<script>
    ...
    $(function () {
        ...
        var val1={};
        $.ajax({
            url: "${ctx}/assessment/statistics/subject",
            type: "POST",
            data: val1,
            async: false,
    ...
    function daochu() {
        window.open("${pageContext.request.contextPath}/assessment/teacher/export?evType=${evType}&name=" + data.name + "&schoolYear=" + data.schoolYear + "&termCode=" + data.termCode + "&gradeId=" + data.gradeId + "&teamId" + data.teamId + "& data.subjectCode" + data.subjectName + "&week=" + data.week + "");
    }
