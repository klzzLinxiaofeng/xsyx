...
<script type="text/javascript">
    ...
    function downLoadModel() {
        ...
        if (checkerSelect.form()) {
            ...
            var url = "${ctp}/Literacy/student/downloadSubject?" +
            "schoolYear="+schoolYear+"&schoolTrem="+schoolTrem+"&gradeId="+gradeId+"&teamId="+teamId+
            "&subjectId="+subjectId;
            if(zhibiaoId!=null && zhibiaoId!=""){
                url+="&zhibiaoId="+zhibiaoId;
            }
            loader.show();
    ...
    $("#gradeId").change(function(){
        $("#subjectId").html('<option value="">全部</option>');
        //添加班级
        $("#bj").html('<option value="">请选择</option>');
        $("#zhibiaoId").html('<option value="">全部</option>');
        //添加班级
    ...
    $("#subjectId").change(function () {
        $("#zhibiaoId").html('<option value="">全部</option>');
        //添加指标
        addOption("/pingyumoban/findByZhiBiao?gradeId="+$("#gradeId").val()+"&subjectId="+$("#subjectId").val()+"&schoolYear="+$("#schoolYear").val()+"&schooolTrem="+$("#schoolTrem").val(), "zhibiaoId", "id", "literacy_name");
