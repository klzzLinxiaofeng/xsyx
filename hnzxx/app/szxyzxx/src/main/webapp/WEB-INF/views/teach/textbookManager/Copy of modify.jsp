				...
				<div class="widget-container" style="padding: 20px 0 0;">
					<form class="form-horizontal tan_form" id="textbookmanager_form" action="javascript:void(0);">
							...
							<div class="control-group">
								...
								<div class="controls">
								<select id="termCode" name="termCode" disabled="disabled"  class="chzn-select" style="width:160px;">
							...
							<div class="control-group">
								...
								<input type="text" id="teacherName" name="teacherName"  readonly="readonly" class="span13" placeholder="" value="${textbookManager.teacherName}" style="width:200px;">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<input type="text" id="gradeCodeName" name="gradeCodeName" readonly="readonly"  class="span13" placeholder="" value="${textbookManager.gradeCodeName}" style="width:200px;">
								</div>
							</div>
							...
							<div class="control-group" id="teamCount">
								...
								<input type="radio" checked="checked" id="countTypeTeam" name="countType" class="span13" placeholder="" value="0" style="width:50px;" onchange="getNumFromTeam();">自动获取
								<input type="radio" id="countTypeHandle" name="countType" class="span13" placeholder="" value="1" style="width:50px;">非自动获取
...
<script type="text/javascript">
	var checker;
	$(function() {
		/* alert('${textbookManager.schoolYear}');
