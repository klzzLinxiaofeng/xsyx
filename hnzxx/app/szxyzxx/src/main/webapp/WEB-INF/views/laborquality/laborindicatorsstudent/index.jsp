                ...
                <div class="content-widgets">
                    <div class="widget-container">
                        ...
                        <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                            ...
                            <jsp:param name="url" value="/laborBehavior/findByAll/list?sub=list"/>
...
<script type="text/javascript">
    function search() {
        ...
        var url = "/laborBehavior/findByAll?sub=list";
        myPagination(id, val, url);
    }
    function pingjia(){
        $.initWinOnTopFromLeft('评价指标预设', '/laborIndicator/findByAll?sub=index', '1000', '550');
    }
