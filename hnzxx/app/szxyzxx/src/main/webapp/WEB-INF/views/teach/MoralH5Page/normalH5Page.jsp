...
<title>发展评价数据分析</title>
<script type="text/javascript">
var role = $(".controllerData").attr("data-role");
var urlSearchForTeam = "${sca:getESBServerUrl()}/school/moral/progress/summaryByTeam/jsonp";
var urlSearchForGrade = "${sca:getESBServerUrl()}/school/moral/progress/summaryByGrade/jsonp";
var urlSearchForSchool = "${sca:getESBServerUrl()}/school/moral/progress/summaryBySchool/jsonp";
$(function(){
    ...
    $(".personal").on("click","li div",function(){//单个学生选中时查询
        ...
        if(role != "PARENT"){
        	var urlForStudent = "${sca:getESBServerUrl()}/school/moral/progress/summaryByTeam/jsonp";
...
<c:choose>
  ...
  <c:otherwise><!-- 其他角色进入显示 -->
    <div class="choice-term" style="width:27%;line-height: 30px;">
	        <p><span class="xq_name"></span><span class="tog">﹀</span></p>
	</div>
    <div class="choice_prom"></div>
  </c:otherwise>
...
<c:if test="${role == 'CLASS_MASTER' }">
	<div class="classify" style="background: #f6f6f6;">
	    ...
	    <a href="javascript:void(0);" onclick="bystu()" id="two">个人</a>
	</div>
</c:if>
<div class="clear"></div>
...
<div class="analysis" style="background:#fff;">
    ...
    <div class="tst"></div>
    <div class="specific">
        <h2><span class="count">总数量0</span></h2><!-- <span style="color:#2299ee;margin-right:10px;">发展评价卡</span> -->
...
<!--             <tr> -->
<!--                 <td class="project"><p class="name her">品德发展评价卡1</p></td> -->
<!--                 <td> -->
...
<div class="details-table" id="details-table2">
    <table>
        <thead>
            <tr>
                <th style="width: 180px;" class="project">评价卡</th>
...
<!--             <tr> -->
<!--                 <td class="project"><p class="name her">品德发展评价卡2</p></td> -->
<!--                 <td> -->
<!--                     <span class="green">5</span> -->
<!--                     <div class="schedule"> -->
<!--                         <p class="green" style="width:100%";></p> -->
...
function bystu(){
	...
	$.ajax({
		type : "GET",
		url:"${sca:getESBServerUrl()}/school/moral/progress/summaryByStu/jsonp",
			...
			if(data.length>0){
				for(var i=0;i<data.length;i++){
					...
					if(data[i].url == null || data[i].url == ""){
						$(".details-table2").append("<tr><td class='project'>"+
													"<img class='use_pic' src='${pageContext.request.contextPath}/res/images/noPhoto.jpg'>"+
													"<p class='name her'>"+data[i].studentName+"</p></td><td>"+
						...
						$(".details-table2").append("<tr><td class='project'>"+
													"<img class='use_pic' src='"+data[i].url+"'>"+
													"<p class='name her'>"+data[i].studentName+"</p></td><td>"+
														"<span class='green'>"+data[i].count+"</span>"+
														  	"<div class='schedule'>"+
														  		"<p class='green' style='width:"+percent+"';></p>"+
...
// 		$(".personal").html("<img src='${pageContext.request.contextPath}/res/css/dygl/images/tushi.png' style='width:799px;height:920px;position: absolute;top: 35%;left: 0;right: 0;'>");
// 		return false;
// 	}
...
function parentFindStudentList (newyear,newmonth,teamId,termCode,studentId){
	...
	if($("#select_div_week").is(":hidden")){
	    ...
	    $.ajax({  
			type : "GET",  
			url : "${sca:getESBServerUrl()}/school/moral/progress/summaryByTeam/jsonp",
			dataType : "jsonp",//数据类型为jsonp  
			jsonp: "jsonpCallback",//服务端用于接收callback调用的function名的参数
			data:{
				termCode  : termCode,
			...
			$(".specific").css("margin-top","10px")
				...
				if(data.length>0){
					...
					$(".tst").show();
					$(".specific").hide();
					$(".tst").html("<div style='background: #fff;width:100%;height:700px;position: absolute;top: 385px;left: 0;right: 0;'><img src='/res/css/dygl/images/unhappy.png' style='margin: 20px auto 50px;display: block;'><p style='text-align: center;font-size:24px;color:#000'>孩子们当前没有受到表扬，请继续努力~</p></div>");
					return false;
				}
				$.ajax({
					type : "GET",  
