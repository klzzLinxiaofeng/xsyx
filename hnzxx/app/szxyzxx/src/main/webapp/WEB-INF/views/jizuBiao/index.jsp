            ...
            <div class="content-widgets">
                <div class="widget-container">
                    ...
                    <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                        ...
                        <jsp:param name="url" value="/jizu/teacherAll?sub=list&jiZuId=${jiZuId}"/>
...
<script type="text/javascript">
    function chaxun() {
        ...
        var url = "/jizu/teacherAll?sub=list&jiZuId="+jiZuId;
    ...
    function initSelect() {
        //初始填充部门
        addOption('/jizu/depentAll', "bm", "id", "name")
        //初始填充科目
        addOption('/jizu/subjectAll', "km", "code", "name")
    }
    ...
    function yichu(id) {
        var jiZuId=$("#jiZuId").val();
        $.post("${ctp}/jizu/addTeacherJiZu?jiZuId="+jiZuId+"&teacherId="+id, function (d) {
                if ("success" === d) {
                    $.success("添加成功");
                    chaxun();
                } else{
