...
//             nextLabel: 'Next',
    ...
    layui.use('upload', function(){
        ...
        var uploadInst = upload.render({
            elem: '#upFile' //绑定元素
            ,url: '${pageContext.request.contextPath}/PinDeMoBan/upLoadPingYuScore' //上传接口
        ...
        if (listSuccess.length == 0) {
            ...
            for (var i = 0, len = listSuccess.length; i < len; i++) {
                $("#successResultId").append("<tr id='data"+i+"'>" +
                    ...
                    "<td>"+listSuccess[i]['zhibiao_name']+"</td>" +
                    "<td>"+listSuccess[i]['ztName']+"</td>" +
                    "<td>"+listSuccess[i]['text']+"</td>" +
        ...
        if(listFail.length == 0){
            ...
            for(var k = 0, lenTemp = listFail.length; k < lenTemp; k++){
                $("#failResultId").append("<tr id='data2"+k+"'>" +
                    ...
                    "<td>"+listFail[k]['zhibiao_name']+"</td>" +
                    "<td>"+listFail[k]['ztName']+"</td>" +
                    "<td>"+listFail[k]['text']+"</td>" +
