                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function() {
                                                        ...
                                                        if (parent.core_iframe != null) {
                                                            parent.core_iframe.window.location.href = "${pageContext.request.contextPath}/learningDesignpublish/publishDetails?index=index&microPublishedId=${microPublishId}&relateId=${relateId}&relateType=${relateType}";
                                                        } else {
                                                            parent.window.location.href = "${pageContext.request.contextPath}/learningDesignpublish/publishDetails?index=index&microPublishedId=${microPublishId}&relateId=${relateId}&relateType=${relateType}";
                                                        }
                                                        $.closeWindow();
                                                        loader.close();
                                                    }
