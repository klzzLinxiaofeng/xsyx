    ...
    <body>
        <div class="container-fluid">
            <jsp:include page="/views/embedded/navigation.jsp">
                ...
                <jsp:param value="作业学习" name="title" />
...
<%--                             <a href="${pageContext.request.contextPath}/homeworkpublish/play?study=study&microPublishedId=${micro.publishMicroLessonId}&publisherId=${micro.publisherId}" class="start_study">开始学习</a> --%>
                        </div>
                        <div class="xs_right">
                            <ul>
    ...
    <script type="text/javascript">
        $(function() {
            var url = "${pageContext.request.contextPath}/homeworkpublish/ajaxGetStudyJson";
