	...
	<body>
		...
		<p class="top_info">“注：有<b class="b1">${gradeExamStudentCount }</b>人参与本次统计，还有<b class="b1">${noImportStudentCount }</b>人数据未导入。”</p>
			...
			<div class="big-data ">
				...
				<a href="/scoreAnalysis/WeChat/subscribe/${userExamWork.id}/${schoolId}/${userId}/${parentId}"  class="analyze">点击分析</a>
			</div>
			<%-- <div class="big-data " style="height: 211px;">
				...
				<div class="progress_bar">
					...
					<a href="scoreAnalysis/WeChat/subscribe/${userExamWork.id}/${schoolId}/${userId}"  class="analyze">点击分析</a>
				</div> --%>
		</div>
		<script>
			$(function(){
