                ...
                <div class="widget-head">
                    <h3>
                        ...
                        <p class="btn_link" style="float: right;">
                            ...
                            <a href="javascript:void(0)" onclick="importExcel()" class="a4"><i
...
<script type="text/html" id="barDemo">
    ...
    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="del">查看排名</a>
...
<script type="text/javascript">
    ...
    function importExcel() {
        $.initWinOnTopFromLeft('上传周学生评分表', '${ctp}/student/star/student/creator2', '500', '450');
    }
