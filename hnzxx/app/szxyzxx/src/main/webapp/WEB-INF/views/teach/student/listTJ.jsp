...
<input type="hidden" id="totalPages" name="totalPages" value="${page.totalPages}" />
 ...
 <c:forEach items="${studentListfinish}" var="student">
	 <tr>
...
<td>总页数${page.totalPages}===当前页${page.currentPage}==每页长度${page.pageSize}</td>
<td style="border:0 none;padding-top:15px;" colspan="10">
	<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
		<jsp:param name="id" value="module_list_content" />
		<jsp:param name="url"  value="/teach/student/studentTJfinish?sub=list&dm=${param.dm}" />
