...
<div class="container-fluid">
    <jsp:include page="/views/embedded/navigation.jsp">
        <jsp:param name="title" value="班级大课间"/>
...
<script type="text/javascript">
    ...
    function getTableOption(){
        ...
        , cols: [[
                ...
                {field: 'jtc', title: '进退场得分',width:120, align: 'center'},
                {field: 'tsc', title: '热身操得分', width:120,align: 'center'},
                {field: 'kfpc', title: '跑操得分', width:120,align: 'center'},
                {field: 'gxtnc', title: '体能素质得分', width:120,align: 'center'},
                {field: 'stmjhd', title: '跳绳活动得分', width:120,align: 'center'},
                {field: 'fsc', title: '放松操得分', width:120,align: 'center'},
                {field: 'jf', title: '加分', width:120,align: 'center'},
    ...
    function addPage() {
        $.initWinOnTopFromLeft('导入班级大课间', '/dy/ex/dkj/addPage', '500', '500');
    }
    ...
    function delCheck(){
        ...
        layer.confirm('确定删除所选数据？', function(index){
            var li=layer.load(2);
            $.post('/dy/ex/dkj/delete',{ids:ids},function(d){
                layer.close(li);
                layer.close(index);
                d=JSON.parse(d);
                if(d.code==200) {
