...
<script type="text/javascript">
	...
	function onCheck(event, treeId, treeNode) {
		...
		if(treeNode.checked) {
			creator(treeNode.id, groupId);
		} else {
			sweeper(treeNode.id, groupId);
		}
	}
	
	function creator(permissionCode, groupId) {
		var requestData = {"permissionCode" : permissionCode, "groupId" : groupId};
		$.post("${pageContext.request.contextPath}/sys/gmodule/creator", requestData, function(data, status) {
			if("success" === status) {
	...
	function sweeper(permissionCode, groupId) {
		var requestData = {"permissionCode" : permissionCode, "groupId" : groupId};
		$.post("${pageContext.request.contextPath}/sys/gmodule/sweeper", requestData, function(data, status) {
			if("success" === status) {
