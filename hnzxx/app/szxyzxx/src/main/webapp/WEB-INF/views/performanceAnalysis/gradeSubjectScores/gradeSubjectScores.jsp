                    ...
                    <div class="widget-container">
                        ...
                        <div class="select_b">
                            ...
                            <div class="select_div"><span>考试名称：</span>
                                <select id="ks" name="ks" class="chzn-select" style="width:200px;padding-top: 4px;">
                                    <option value="">请选择</option>
                                </select>
                            </div>
...
<script type="text/javascript">
    ...
    function getTableOption(){
        var option= {
            ...
            , cols: [[
                ...
                ,{field:'qzpjf', title: '全镇平均分', align: 'center',width: 100}
                ...
                ,{field:'qzhgl', title: '全镇合格率', align: 'center',width: 100}
                ...
                ,{field:'qzysl', title: '全镇优生率', align: 'center',width: 100}
    ...
    function initSelect(){
        ...
        $("#nj").change(function(){
            ...
            var v=$(this).val();
            if(v!="") {
                addOption("/grade/subject/queryExamName?xn="+$("#xn").val()+"&xq="+$("#xq").val()+"&nj="+v, "ks", "examName", "examName")
            }
        })
        ...
        $("#ks").change(function(){
            ...
            var v=$(this).val();
            if(v!="") {
                addOption("/grade/subject/queryExamSubject?xn="+$("#xn").val()+"&xq="+$("#xq").val()+"&nj="+$("#nj").val()+"&examName="+v, "km", "uuid", "name")
            }
        })
