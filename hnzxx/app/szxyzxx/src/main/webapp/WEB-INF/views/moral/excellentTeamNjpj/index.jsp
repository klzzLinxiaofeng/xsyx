...
<div class="container-fluid">
    <jsp:include page="/views/embedded/navigation.jsp">
        <jsp:param name="title" value="班级年级评价"/>
...
<script type="text/javascript">
    ...
    function getTableOption(){
        ...
        , cols: [[
                ...
                {field: 'wspj', title: '卫生评价得分', align: 'center'},
                {field: 'whjspj', title: '文化建设评价得分', align: 'center'},
    ...
    function addPage() {
        $.initWinOnTopFromLeft('导入班级年级评价', '/dy/ex/bjpj/addPage', '500', '500');
    }
    ...
    function delCheck(){
        ...
        layer.confirm('确定删除所选数据？', function(index){
            var li=layer.load(2);
            $.post('/dy/ex/bjpj/delete',{ids:ids},function(d){
                layer.close(li);
                layer.close(index);
                d=JSON.parse(d);
                if(d.code==200) {
