...
<script type="text/javascript">
	$(function() {
		...
		$.get("${ctp}/bbx/teamSyllabusZouban/list/json", $requestData, function(data, status) {
			if("success" === status) {
				data = eval("(" + data + ")");
				// TODO 检查班级是否绑定教室
						...
						if ( value.type === 1 )	{
							...
							if(subjectName != null && subjectName != ""){
								kbCell.html("<div data-kbDm='" + kbDm + "' course-type='"+value.type+"' class='kb_cell'>" + 
										"<p class='kc_mc'>" + subjectName + "</p>" + "<p class='rk_js'>" + jiaosMc + "</p>" + "</div>");
							}	
						} else if ( value.type === 2 ) {
							var roundHtml = "";
							...
							if(subjectName != null && subjectName != ""){
								kbCell.html("<img src='${ctp}/res/images/bbx/bp/syllabus/tips.png' class='zhao_pic'><div data-kbDm='" + kbDm + "' course-type='"+value.type+"' class='kb_cell'>" + 
									...
									"<p class='rk_js'>" + jiaosMc + roundHtml + "</p>" + memberInfo + "</div>");
							}
