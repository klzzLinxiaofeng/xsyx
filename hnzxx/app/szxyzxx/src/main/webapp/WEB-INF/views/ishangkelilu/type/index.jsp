            ...
            <div class="content-widgets">
                <div class="widget-container">
                    <div class="select_b">
                        ...
                        <button type="button" class="btn btn-primary" onclick="loadViewerPage()">新建类型</button>
                        <div class="clear"></div>
                    </div>
                    ...
                    <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                        ...
                        <jsp:param name="url" value="/studey/type/allType?sub=list"/>
...
<script type="text/javascript">
    ...
    function search() {
        var name=$("#name").val();
            ...
            var url = "/studey/type/allType?sub=list";
            var val={};
            if(name!=null && name!=""){
                 val.name=name;
            }
    ...
    function loadViewerPage() {
        initWinOnTopFromLeft('添加类型', '/studey/type/createOrUpdate', '1200', '650');
    }
    //删除
    function ddelete(id) {
        $.get("${ctp}/studey/type/delete?id="+id, function (data, status) {
            if ("success" === status) {
                if ("success" === data) {
                    $.success("删除成功");
                    $("#" + id + "_tr").remove();
    ...
    //编辑
    function bianji(id) {
        initWinOnTopFromLeft('编辑类型', '/studey/type/createOrUpdate?id='+id, '1200', '650');
    }
</script>
