...
<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/moralWidget/teamWidget.js"></script>
<title>班集体评价报表</title>
<style>
...
.details-table table tbody.details-table table tbody, tbody.details-table2, tbody.normaltablelist,.details-table{
    font-size: 23px;
}
...
var appGetGradeId = "${gradeId}";
var urlSearchForGrade
...
$(function(){
	...
	urlForTableList = "${sca:getESBServerUrl()}/school/moral/team/summaryByTeam/jsonp";
	urlSearchForGrade = "${sca:getESBServerUrl()}/school/moral/team/summaryByGrade/jsonp";
...
// 	alert("!@#$"+appGetTermCode+"////"+appGetTeamId+"////"+appGetBeginDate+"////"+appGetEndDate)
