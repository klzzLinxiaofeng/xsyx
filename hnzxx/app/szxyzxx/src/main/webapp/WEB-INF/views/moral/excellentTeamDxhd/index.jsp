...
<div class="container-fluid">
    <jsp:include page="/views/embedded/navigation.jsp">
        <jsp:param name="title" value="班级大型活动得分"/>
...
<script type="text/javascript">
    ...
    function getTableOption(){
        ...
        , cols: [[
                ...
                {field: 'of_date', title: '日期', align: 'center'},
                {field: 'xqy', title: '学期月', align: 'center'},
                {field: 'xqz', title: '学期周', align: 'center'},
                {field: 'zycy', title: '主动参与得分', align: 'center'},
                {field: 'jjph', title: '积极配合得分', align: 'center'},
    ...
    function addPage() {
        $.initWinOnTopFromLeft('导入班级大型活动得分', '/dy/ex/dxhd/addPage', '500', '500');
    }
    ...
    function delCheck(){
        ...
        layer.confirm('确定删除所选数据？', function(index){
            var li=layer.load(2);
            $.post('/dy/ex/dxhd/delete',{ids:ids},function(d){
                layer.close(li);
                layer.close(index);
                d=JSON.parse(d);
                if(d.code==200) {
