						...
						<h3>
							...
							<p class="btn_link" style="float: right;">
								...
								<a href="javascript:void(0)" class="a4"
									onclick="loadCreatePage();"><i class="fa fa-plus"></i>添加教案</a>
								</c:if>
							</p>
						</h3>
					</div>
					...
					<div class="content-widgets">
						<div class="widget-container">
							...
							<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
								...
								<jsp:param name="url" value="/generalTeachingAffair/lessonplan/index?sub=list&dm=${param.dm}&type=${type}" />
...
<script type="text/javascript">
	...
	function search() {
		...
		var url = "/generalTeachingAffair/lessonplan/index?sub=list&dm=${param.dm}&type=${type}";
		myPagination(id, val, url);
	}

	// 	加载创建对话框
	function loadCreatePage() {
		$.initWinOnTopFromLeft('创建', '${ctp}/generalTeachingAffair/lessonplan/creator', '700', '500');
	}
	//  加载编辑对话框
	function loadEditPage(id) {
		$.initWinOnTopFromLeft('编辑', '${ctp}/generalTeachingAffair/lessonplan/editor?id=' + id, '700', '500');
	}
	
	function loadViewerPage(id) {
		$.initWinOnTopFromLeft('详情', '${ctp}/generalTeachingAffair/lessonplan/viewer?id=' + id, '700', '500');
	}
	...
	function executeDel(obj, id) {
		$.post("${ctp}/generalTeachingAffair/lessonplan/" + id, {"_method" : "delete"}, function(data, status) {
			if ("success" === status) {
				if ("success" === data) {
					$.success("删除成功");
					$("#" + id + "_tr").remove();
