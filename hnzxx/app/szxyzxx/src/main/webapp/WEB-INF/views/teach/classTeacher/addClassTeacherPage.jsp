		...
		<div class="span12">
			<div class="content-widgets" style="margin-bottom:0">
				<div class="widget-container" style="padding:10px 0 0;">
					<form class="form-horizontal tan_form" id="addClassTeacherForm" action="javascript:void(0);">
...
<script type="text/javascript">
		...
		function saveOrUpdate() {
			...
			var url = "${pageContext.request.contextPath}/teach/classTeacher/addClassTeacher";
			loader.show();
