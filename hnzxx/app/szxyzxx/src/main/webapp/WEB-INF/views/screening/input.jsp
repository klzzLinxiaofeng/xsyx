                        ...
                        <div class="list">
                            <form class="form-horizontal" id="applyrepair_form">
                                <div class="control-group">
                                    ...
                                    <div class="textarea">
                                        <input type="button" id="paichaName" onclick="openteacher()" name="paichaName" style="width:800px;height:100px;" value="${userInfo.realName}"/>
                                    </div>
                                </div>
                                <div class="x-up">
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div>
                                            <input type="text" id="screeningArea"  name="screeningArea"/>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function teacherList(){
        ...
        $.get(url,function(d){
            ...
            for(var a=0;a<obj.length;a++){
                ...
                $("#td_"+obj[a]['id']).attr("onclick","teacherQueding('"+obj[a]['user_id']+"','"+obj[a]['name']+"')");
            }
        })
    }
    //确定老师
    ...
    function chushi() {
        var benren="${userInfo.realName}";
        var div="<div style='display: inline;float: left;position: relative;' id='ddd_${userInfo.id}'><input name='teachId' style='display: none' type='text' value='${userInfo.id}'/><input readonly style='height: 40px;width: 80px;text-align: center;cursor: default;border: 1px solid #d9d9d9' name='teaName' value='"+benren+"'/></div>";
        $("#yixuanTeacher").append(div);
    }
</script>
</body>
