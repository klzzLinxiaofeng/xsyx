...
<html>
                        ...
                        <div class="content-widgets">
                            <div class="widget-container">
                                ...
                                <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                                    ...
                                    <jsp:param name="url" value="/learningDesignpublish/studyHistory" />
    ...
    <script type="text/javascript">
                                            function watchReviews(publishId, userId) {
                                                var mes = "查看评语";
                                                $.initWinOnTopFromLeft(mes, '${pageContext.request.contextPath}/learningDesignpublish/watchReviews?microPublishedId=' + publishId + '&userId=' + userId, '800', '300');
                                            }
                                            ...
                                            function changeSubject(subjectName) {
                                                ...
                                                var url = "/learningDesignpublish/studyHistory";
