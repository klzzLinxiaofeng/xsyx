...
<div class="container-fluid">
	...
	<div class="content_main white">
		...
		<div class="input_select" <c:if test='${user.userName != "superAdmin"}'>style="display: none;"</c:if>>
		...
		<div class="input_select">
			...
			<button class="btn btn-oxfordGray fr downApply">下架应用</button>
		...
		<table class="table">
			...
			<tbody id="schoolApplet_list_content">
				<jsp:include page="./schoolIndexList.jsp" />
			</tbody>
		</table>
		<div class="page_div">
			<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
				<jsp:param name="id" value="schoolApplet_list_content" />
				<jsp:param name="url" value="/sys/applet/school/searchOwnerApplet" />
...
$('.downApply').click(function(){
	 ...
	 if(ownerId == ""){
		$.alert("请选择学校");
		 ...
		 $.initWinOnTopFromLeft_qyjx("下架应用", '${ctp}/sys/applet/school/downApplet/'+ownerId, '600', '500');
	}
});
...
function search(obj){
	...
	var id = "schoolApplet_list_content";
...
function batchDown(){
	var ids = "";
	var val ={};
	var ckList = $("#schoolApplet_list_content .ck.on");
