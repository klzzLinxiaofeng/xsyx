            ...
            <div class="content-widgets">
                <div class="widget-container">
                    ...
                    <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                        ...
                        <jsp:param name="url" value="/practice/innovation/student/json?sub=list"/>
...
<script type="text/javascript">
    function search() {
        ...
        var url = "/practice/innovation/student/json?sub=list";
    ...
    function chakan(id){
        window.open('/practice/innovation/chakan?sub=index&studentId='+id);
    }
