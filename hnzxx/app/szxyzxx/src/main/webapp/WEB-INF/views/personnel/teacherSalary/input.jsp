				...
				<div class="widget-container" style="padding: 20px 0 0;">
					<form class="form-horizontal tan_form" id="teacherSalary_form" action="javascript:void(0);">
							<div class="control-group">
								...
								<div class="controls">
								<input type="text" id="teacherId" name="teacherId" class="span4" data-id="${teacherSalary.teacherId}"
									placeholder="" value="${teacherSalary.name}" ${isCK != null && isCk != '' ? "disabled='disabled'" : ""}>
								</div>
							</div>
