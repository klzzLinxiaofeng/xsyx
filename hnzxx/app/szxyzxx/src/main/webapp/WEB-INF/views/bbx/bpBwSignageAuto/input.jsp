				...
				<div class="widget-container" style="padding: 20px 0 0;">
					<form class="form-horizontal tan_form" id="signageauto_form" action="javascript:void(0);">
							<div class="control-group">
								...
								<div class="controls" id="classMasterSearch">
									<select  id="bj" name="teamId" class="span4 chzn-select" style="width: 120px;"></select>
								</div>
								<div class="controls" id="schoolManagerSearch">
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<input type="text" id="wednesdayCloseTime" name="wednesdayCloseTime" placeholder="关机时间"									
										...
										value="<fmt:formatDate value="${signageAutoVo.wednesdayOpenTime}" pattern="HH:mm"/>" /> 
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if (checker.form()) {
			...
			var url = "${ctp}/bbx/signageAuto/creator";
			loader.show();
