...
//             nextLabel: 'Next',
	...
	layui.use('upload', function(){
		...
		var uploadInst = upload.render({
			elem: '#upFile' //绑定元素
			,url: '${pageContext.request.contextPath}/teach/studentScore/upLoadScoreInfo' //上传接口
    ...
    function loadTable(listSuccess,listFail){
    	...
    	if (listSuccess.length == 0) {
    		...
    		for (var i = 0, len = listSuccess.length; i < len; i++) {
    			parSucc+="<tr><td>"+listSuccess[i].studentId+"</td><td>"+listSuccess[i].studentNumber+"</td><td>"+listSuccess[i].studentName+"</td><td>"+listSuccess[i].score+"</td><td>"+'成功'+"</td></tr>";
    		}
