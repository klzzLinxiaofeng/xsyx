    ...
    <div class="pd20">
        ...
        <div class="kwgl_main">
            <div class="ks_list" style="padding:0">
                <div class="all_table">
                    <jsp:include page="./tk_nj_cj_list.jsp" />
                    <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                        <jsp:param name="id" value="all_table" />
                        <jsp:param name="url" value="/teach/scoreStatistics/analysis/grade?examWorksId=${examWorksId}&gradeId=${gradeId}&sub=1&form=1" />
...
<script>
    $(function(){
        ...
        $(".fd_table table tbody tr td").hover(function(){
    ...
    function toStudent(userId, teamId){
        window.parent.location.href="${pageContext.request.contextPath}/teach/scoreStatistics/analysis/student?examWorksId=${examWorks.id}&userId=" + userId + "&teamId=" + teamId + "&backSign=2";
    }
