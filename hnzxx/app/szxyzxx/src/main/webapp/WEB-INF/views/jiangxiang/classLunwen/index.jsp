...
<script type="text/javascript">
    function search() {
        ...
        var teacherName=$("#teacherName").val();
            ...
            var url = "/huojiangFenXin/findByHuoJiangAll?sub=list";
            myPagination(id, val, url);
    }

    //导出
    function daochu() {
        var url="/huojiangFenXin/findByHuoJiangExport?leixing=1";
        var startDate=$("#startDate").val();
        var endDate=$("#endDate").val();
        var type=$("#type").val();
        var theme=$("#theme").val();
    ...
    function xiangqing(id,teacherId) {
        location.href="/huojiangFenXin/findByhuojiangId?id="+id+"&teacherId="+teacherId;
    }
