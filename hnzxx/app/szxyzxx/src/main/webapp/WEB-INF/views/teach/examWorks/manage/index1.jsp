...
<script>
    ...
    function getTerm() {
        ...
        var teamId = "${teamId}";
        $.get("${ctp}/teach/examWorks/team/list/json", {"year":year, "isMaster": true}, function(data, status) {
            if ("success" === status) {
                data = eval("(" + data + ")");
                var $team = $("#team");
                $team.html("");
...
//                search();
    ...
    function toClassIndex(){
        window.location.href="${pageContext.request.contextPath}/teach/examWorks/manage/class/index?isMain=false";
    }
