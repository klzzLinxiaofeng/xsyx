...
<body>
	<div class="container-fluid">
		<jsp:include page="/views/embedded/navigation.jsp">
			<jsp:param name="title" value="默认角色管理" />
						...
						<h3>
							...
							<p class="btn_link" style="float: right;">
								...
								<a href="javascript:void(0)" class="a4"
									onclick="loadCreatePage();"><i class="fa fa-plus"></i>创建默认角色</a>
							</p>
						</h3>
					</div>
					...
					<div class="content-widgets">
						<div class="widget-container">
							...
							<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
								...
								<jsp:param name="url"
									value="/sys/role/def/index?sub=list&dm=${param.dm}" />
...
<script type="text/javascript">
	...
	function search() {
		...
		var url = "/sys/role/def/index?sub=list&dm=${param.dm}";
	...
	function loadCreatePage() {
		$.initWinOnTopFromLeft('创建角色',
				'${pageContext.request.contextPath}/sys/role/def/creator', '560',
				'300');
	}
	//  加载编辑角色对话框
	function loadEditPage(id, isCK) {
		...
		$.initWinOnTopFromLeft(mes,
				'${pageContext.request.contextPath}/sys/role/def/editor?id=' + id
						+ '&isCK=' + isCK, '560', '300');
	}
	// 	授权菜单
