			...
			<div class="content-widgets" style="margin-bottom: 0">
				...
				<div class="widget-head" style="height:40px;border-bottom:0 none">
						<p style="float: right;margin-bottom:0" class="btn_link">
							<a id="downLoadExcel"  class="a3" href="" onclick="downLoadExcel();" ><i class="fa fa-plus"></i>导出学生科目成绩记录</a>
						</p>
					</div>
...
function downLoadExcel(){
	...
	var url = "${pageContext.request.contextPath}/teach/scoreSelect/simpleTeacher/downLoadExcel?";
	 url = url+param;
	 url =  encodeURI(url);
