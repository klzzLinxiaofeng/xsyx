...
<!-- 								class="{required : true}" -->
							...
							<div class="control-group">
								...
								<div class="controls">
								<input type="text" id="price" name="price" class="span13 {max:999999999,digits:true}" placeholder="请输入价格（元）" value="${device.price}">（元）
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">
								...
								<div class="controls">
								<input type="text" id="totalNumber" name="totalNumber" class="span13 {max:999999999,digits:true}" placeholder="请输入设备数量" value="${device.totalNumber}">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">
