...
<head>
    ...
    <script src="${ctp}/res/js/qrcode.js"></script>
</head>
<body>
<div class="row-fluid">
    <div class="span12">
            ...
            <div class="content-widgets">
                <div class="widget-container">
                    <div class="select_b">
                        ...
                        <button type="button" class="btn btn-primary" onclick="PiLiangCreateERWerma()">一键生成二维码</button>
          <%--              <button type="button" class="btn btn-primary" onclick="PiLiangXiaZaiERWerma()">一键下载二维码</button>--%>
                        <div class="clear"></div>
                    </div>
                    ...
                    <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                        ...
                        <jsp:param name="url" value="/aesthetic/showErWeiMa?sub=list"/>
...
<script type="text/javascript">
    ...
    */
    function createBtn(id) {
        $.get("/aesthetic/CreateERWerma?studentId="+id+"+&schoolId=215", function (d) {
            $.success(d);
            search();
    })
    }
    ...
    /*批量生成二维码*/
    function PiLiangCreateERWerma() {
        var url="/aesthetic/PiLiangCreateERWerma?";
        var xn = $("#xn").val();
        var gradeId = $("#nj").val();
        var teamId = $("#bj").val();
    ...
    function downloadImg(id){
        var url ="/aesthetic/XiaZaiERWerma?id="+id;
        location.href=url;
           /* $.get("/aesthetic/XiaZaiERWerma?id="+id, function (d) {
                $.success(d);
            })*/
    }
    /*批量下载二维码*/
    function PiLiangXiaZaiERWerma(){
        var xn = $("#xn").val();
        var gradeId = $("#nj").val();
        var teamId = $("#bj").val();
        var stuName = $("#stuname").val();
        var url ="/aesthetic/PiLiangXiaZaiERWerma?xn="+xn+"&gradeId="+gradeId+"&teamId="+teamId+"&studentName="+stuName;
        location.href=url;
        /* $.get("/aesthetic/XiaZaiERWerma?id="+id, function (d) {
             $.success(d);
         })*/
    ...
    function search() {
        ...
        var teamId = $("#bj").val();
        var stuName = $("#stuname").val();
        var url = "/aesthetic/showErWeiMa?sub=list";
        if (xn != null && xn != "") {
            url=url+"&xn="+xn;
        }
        if (gradeId != null && gradeId != "") {
