			...
			<div class="content-widgets" style="margin-bottom: 0">
				<div class="widget-container" style="padding: 20px 0 0;">
					<form class="form-horizontal padding15" style="padding: 15px;" id="bwuserinfo_form">
						<input type="hidden" id="userId" name="userId" value="${bwUserInfo.userId}" />					
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if (checker.form()) {
			...
			document.getElementById("characteristic").value=characteristic;
// 			var characteristic = $("#characteristic").val();
			var $requestData = formData2JSONObj("#bwuserinfo_form");
			var url = "${ctp}/clazz/classMember/setCharacteristic";
			if ("" != $id) {
				$requestData._method = "put";
				url = "${ctp}/clazz/classMember/" + $id;
			}
			loader.show();
