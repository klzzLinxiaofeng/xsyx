...
<html>
                        ...
                        <div class="content-widgets">
                            <div class="widget-container">
                                ...
                                <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                                    ...
                                    <jsp:param name="url" value="/exampublish/studyHistory" />
    ...
    <script type="text/javascript">
                                            function watchReviews(publishId, userId) {
                                                var mes = "查看评语";
                                                $.initWinOnTopFromLeft(mes, '${pageContext.request.contextPath}/exampublish/watchReviews?microPublishedId=' + publishId + '&userId=' + userId, '800', '300');
                                            }
                                            ...
                                            function changeSubject(subjectName) {
                                                ...
                                                var url = "/exampublish/studyHistory";
