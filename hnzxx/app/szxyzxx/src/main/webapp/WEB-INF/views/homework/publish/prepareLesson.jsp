    ...
    <body>
        <div class="container-fluid">
            <jsp:include page="/views/embedded/navigation.jsp">
                ...
                <jsp:param value="布置作业" name="title" />
                        ...
                        <div class="widget-container">
                            <form id="dept_form" class="form-horizontal" novalidate="novalidate">
                                ...
                                <div id="microMainDiv" class="control-group">
                                    <label class="control-label"><font style="color:red">*</font>作业</label>
                                    <div class="controls">
                                        <div class="banji">
                                            <ul class="nj">
                                                ...
                                                <li><a onclick="changeMicroTab($(this).attr('id'))" id="upload" href="javascript:void(0)">上传作业</a></li>
                                            </ul>
                                            <div class="back_tj">
                                            ...
                                            <div class="ts">
                                                <div class="yx_weike">
                                                    <div class="yx_num">
                                                        ...
                                                        <p class="yx">
                                                            <a onclick="showChosenMicroDiv()" href="javascript:void(0)">已选作业<span id="chosenMicroSize">0</span></a>
                                                        </p>
                                                    </div>
                                                ...
                                                <div onclick="publishLesson();" class="btn btn-danger">布置已选作业</div>
        ...
        <script type="text/javascript">
		        ...
		        function chose(dataType){
		            ...
		            if(dataType == "myresource"){//我上传的资源
			        	url = url + "/homeworkpublish/myResource?index=index&resType=3&personType=res_person";
		            }else if(dataType == "favresource"){//我收藏的资源
		            	url = url + "/homeworkpublish/favResource?index=index&resType=3&personType=fav_resource";
		            }else if(dataType == "myshare"){//我的共享
		            	url = url + "/homeworkpublish/myResource/myShare?index=index&resType=3&personType=res_share";
		            }
		        	$(".weike").load(url,function(){});
                                            ...
                                            function changeMicroTab(type) {
                                                ...
                                                if (type == "myMicro") {
                                                    ...
                                                    url = url + "/resource/searcher/index?isPublish=1&stageCode=2&subjectCode="+subjectCode+"&gradeCode="+gradeCode+"&resType=<%=ResourceType.HOMEWORK%>";
                                                    source = "来自公共资源库";
                                	                ...
                                	                var subjectCode = $(".fenban input[type='checkbox']").first().next().val();
                                	                var gradeCode = $(".nj .active input[type='hidden']").val();
                                	                url = url + "/resource/searcher/index?isPublish=0&stageCode=2&subjectCode=" + subjectCode + "&gradeCode=" + gradeCode + "&resType=<%=ResourceType.HOMEWORK%>";
                                	                source = "来自校本资源库";
                                	                $(".kemu_nav").css("display","none");
                                	                $(".back_tj").css({"float":"right","width":"auto"})
                                	            } else if (type == "upload") {
                                                    //本地上传
                                                    url = url + "/homeworkhouse/upload?publish=publish";
                                                    source = "来自我的资源库";
                                                    $(".kemu_nav").css("display","none");
                                                    $(".back_tj").css({"float":"right","width":"auto"})
                                                }
                                            ...
                                            function publishLesson() {
                                                ...
                                                loader.show();
                                                $.ajax({
                                                    url: "${pageContext.request.contextPath}/homeworkpublish/publishLesson",
                                                    type: "POST",
                                                    ...
                                                    success: function() {
                                                        ...
                                                        location.href = "${pageContext.request.contextPath}/homeworkpublish/publishManagerIndex?relateId="+relateId+"&relateType="+relateType;
                                                    }
                                                });
                                            }
                                            ...
                                            function previewMicro(mid) {
                                                var mes = "预览";
                                                $.initWinOnTopFromLeft(mes, '${pageContext.request.contextPath}/homeworkpublish/preview?objId=' + mid, '700', '500');
                                            }
