                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <div id="zp" style="display:inline-block;">
                                <div class="img_1">
                                    <c:if test="${(isCK==''||isCK==null) && (publicClass.url !=null && publicClass.url != '') }">
                                        <a data-id="${publicClass.url}" onclick="reMove(this);">取消</a>
                                    </c:if>
                                    <c:if test="${publicClass.url !=null && publicClass.url != ''}">
                                        <img src="${publicClass.url}" onclick="Change(this);"
