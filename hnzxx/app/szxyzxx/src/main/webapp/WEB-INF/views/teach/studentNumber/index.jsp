				...
				<div class="content-widgets white">
					...
					<div class="content-widgets" style="padding: 20px 20px 1px 20px;">
							...
							<div class="minutes-rated">
	                            <a href="javascript:void(0);" class="see-rated">学号查看</a>
	                            <c:if test="${acl:hasPermission(sessionScope[sca:currentUserKey()].id, param.dm, 0)}">
	                            	<a href="javascript:void(0);" onclick="enter()">学号录入</a>
                            	</c:if>
...
function search(){
	...
	var url = "${pageContext.request.contextPath}/teach/student/studentNumber/list";
	loader.show();
...
function enter(){
	window.location.href="${pageContext.request.contextPath}/teach/student/studentNumber/enterIndex?type=${param.type}&dm=${param.dm}";
}
