				...
				<div class="widget-container" style="padding: 20px 0 0;">
					<form class="form-horizontal tan_form" id="knowledgeCatalog_form" action="javascript:void(0);">
							<div class="control-group">
								...
								<div class="controls">
								<input type="text" id="name" name="name" class="span13" placeholder="" value="">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
								<input type="text" id="level" name="sort" class="span13" placeholder="" value="">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">
								...
								<div class="controls">
									...
									<input type="hidden" id="parentId" name="parentId" class="span13" placeholder="" value="${empty parent.id ? 0 : parent.id}">
								</div>
							</div>
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if (checker.form()) {
			...
			var url = "${ctp}/teach/catalog/creator";
			loader.show();
