...
var urlSearchForTeam = "${sca:getESBServerUrl()}/school/moral/increase/summaryByTeam/jsonp";
var urlSearchForGrade = "${sca:getESBServerUrl()}/school/moral/increase/summaryByGrade/jsonp";
var urlSearchForSchool = "${sca:getESBServerUrl()}/school/moral/increase/summaryBySchool/jsonp";
$(function(){
    ...
    $(".personal").on("click","li div",function(){//单个学生选中时查询
        ...
        if(role != "PARENT"){
        	var urlForStudent = "${sca:getESBServerUrl()}/school/moral/increase/summaryByTeam/jsonp";
...
<div class="message" style="display: none;" data-message="incentive"></div>
...
<div class="analysis" style="background:#fff;">
    ...
    <div class="tst"></div>
    <div class="specific">
        <h2><span class="count">总数量0</span></h2><!-- <span style="color:#2299ee;margin-right:10px;">评价卡</span> -->
...
function parentFindStudentList (newyear,newmonth,teamId,termCode,studentId){
	...
	if($("#select_div_week").is(":hidden")){
	    ...
	    $.ajax({  
			type : "GET",  
			url : "${sca:getESBServerUrl()}/school/moral/increase/summaryByTeam/jsonp",
			dataType : "jsonp",//数据类型为jsonp  
			jsonp: "jsonpCallback",//服务端用于接收callback调用的function名的参数
			data:{
				termCode  : termCode,
