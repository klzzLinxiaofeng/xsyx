 		...
 		<div class="content-widgets" style="margin-bottom:0">
			<div class="widget-container" style="padding: 0;">
				<form class="form-horizontal tan_form" id="studyShare_form" action="javascript:void(0);">
					<div class="trend">
    					<div class="edit">
    					<div class="control-group" id="classMasterSearch" style="padding-top: 20px; margin-left: 20px">
							<select  id="bj" name="teamId1" class="span4 chzn-select" style="width: 120px;"></select>
						</div>	
						<div class="control-group" id="schoolManagerSearch" style="padding-top: 20px; margin-left: 20px">
						...
						<div class="control-group" style="margin-left: 20px">
							<input type="text" id="title" name="title" class="span12" style="width:680px;" placeholder="请输入标题"/>
						</div>
						...
						<span style="margin-right:2px;">高考时间：</span>
							<input style="height: 34px; line-height: 34px; font-size: 12px;width:200px;"
									...
									onclick="WdatePicker({minDate:'%y-%M-%d %H:%m:%s', dateFmt:'yyyy-MM-dd'});"
									placeholder="高考时间" value="" type="text">
						</div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#contentType1").attr("checked","checked");	
		$("#uploadPirture").hide();
		$("#check").attr("checked","checked");
		$("#isCirculate").attr("checked","checked");
	...
	$.validator.addMethod("checkC", function(value, element, param) {
		var result = true;
		var $this = $(element);
	...
	function saveOrUpdate() {
		if (checker.form()) {
			...
			//alert($requestData.examDate);
			if($requestData.examDate != ""){
				$requestData.examDate = $requestData.examDate+" 00:00";
			}
