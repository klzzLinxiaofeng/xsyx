        ...
        <script type="text/javascript">
            ...
            function save() {
                if ($('#dateForm').valid()) {
                    ...
                    var url = "${pageContext.request.contextPath}/micropublish/updatePublishedDate";
                    loader.show();
                    $.post(url, $requestData, function (data, status) {
                        if ("success" === status) {
                            $.alert("修改微课布置时间成功");
                            var reurl = "${pageContext.request.contextPath}/micropublish/publishManagerIndex/?relateId=" + $requestData.relateId;
