                ...
                <form class="form-horizontal tan_form" id="publicClass_time_form" action="javascript:void(0);">
                    <div class="control-group">
                        <label class="control-label">
                            作业布置结束时间<span style="color:red">*</span>:
                        </label>
                        <input type="text" id="kaishiTime" name="kaishiTime" class="chzn-select" autocomplete="off"
                               ...
                               placeholder="xx:xx:xx"
                                value="${timeset.datetime}">
                    </div>
                    <div class="form-actions tan_bottom">
                        <input type="hidden" id="id" name="id" value="${timeset.id}"/>
...
<script type="text/javascript">
    ...
    function saveOrUpdate() {
        ...
        var $id = $("#id").val();
        var times=$("#kaishiTime").val();
        var  url = "${ctp}/home/woke/updateTime?id="+$id;
        loader.show();
        if(times!=null && times!=""){
            url+="&times="+times;
