...
<body>
<h3>全年级良好率对比图</h3>
<svg id="ThreeRatiosOfLow" width="390" height="416" font-family="sans-serif" font-size="10" text-anchor="middle" style="margin:0 auto;display:block;"></svg>
<div class="zw_ts">暂无数据</div>
</body>
<script>
    //年级良好率  在grade_slzhtjdbt.jsp进行初始化数据
    function initThreeRatiosOfLow(data){

        var width  = 590;	//SVG绘制区域的宽度
        var height = 461;	//SVG绘制区域的高度

        d3.select("#ThreeRatiosOfLow").selectAll("g").remove();//清空作图区域
        var svg = d3.select("#ThreeRatiosOfLow"),
