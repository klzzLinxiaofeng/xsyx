                      ...
                      <div class="control-group">
                            ...
                            <div class="controls">
                              ...
                              <input class="input-medium required" type="text" name="meetingName"
									placeholder="会议名称"  value="${meeting.meetingName }"  style="height:30px;line-height:30px;width:180px;">  
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                        <div class="textarea">
                                   <input type="radio" name="meetingType" id="optionsRadios1" value="0" <c:if test="${meeting.meetingType==0 }">checked</c:if> > 一般   
                                   <input type="radio" name="meetingType" id="optionsRadios" value="1" <c:if test="${meeting.meetingType==1 }">checked</c:if>   > 重要
                                </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
									...
									placeholder="主持人"  value="${meeting.zhuchi }"   style="height:30px;line-height:30px;width:130px;">  
                        ...
                        <div class="control-group">
                            ...
                            onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="span5 required"  value="${meeting.starttime }"  style="width:160px;" />
                            
                            至<input type="text" id="d4332" name="endtime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${meeting.endtime }" class="span5 required" style="width:160px;" />
                         ...
                         <div class="control-group">
                            ...
                            <div class="controls">
									...
									placeholder="会议地点"  value="${meeting.address }"   style="height:30px;line-height:30px;width:280px;" >  
                            ...
                            <div class="controls">
                               ...
                               <textarea id="content" name="meetingContent" rows="5"  
										class="span8 required "  placeholder="备注"  >${meeting.meetingContent }</textarea>
                                </div>
                        ...
                        <div class="control-group">
							...
							<div class="controls">
								<div class="textarea">
                                  ...
                                  <span id="teachName"> 
                                  <c:if test="${!empty  meetingUser}">已 选择参会人</c:if>
						...
						<div class="form-actions tan_bottom">
							...
							<button class="btn btn-warning" type="button"
								...
								onclick="cancel('${meeting.id}');">取消会议</button> --%>
						</div>
					</form>
				</div>
			</div>
	...
	function saveOrUpdate() {
		if (checker.form()) {
			...
			var $requestData = formData2JSONObj("#oanotice_form");
				...
				url = "${ctp}/office/meeting/edit/" + $id;
