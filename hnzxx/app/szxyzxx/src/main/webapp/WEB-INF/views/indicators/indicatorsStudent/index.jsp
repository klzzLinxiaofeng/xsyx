            ...
            <div class="content-widgets">
                <div class="widget-container">
                    ...
                    <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                        ...
                        <jsp:param name="url" value="/indicators/student/list/json?sub=list"/>
...
<script type="text/javascript">
    function search() {
        ...
        var url = "/indicators/student/list/json?sub=list";
   ...
   function bianji(id){
       $.initWinOnTopFromLeft('编辑', '/indicators/student/index/bianji?studentId='+id, '1000', '550');
    }
   function chakan(id){
       $.initWinOnTopFromLeft('详情', '/indicators/student/index/xiangqing?studentId='+id, '1000', '550');
    }
