...
<div class="container-fluid">
    <jsp:include page="/views/embedded/navigation.jsp">
        ...
        <jsp:param value="住房登记编辑" name="title" />
        ...
        <div class="span12">
            <div class="content-widgets white">
                <div class="widget-head">
                    <h3 class="x-head content-top"><a href="javascript:void(0);" class="on">住房登记编辑</a><a href="javascript:history.go(-1);" class="back right"><i class="fa fa-arrow-circle-left"></i>返回</a></h3>
                </div>
                ...
                <div class="x-main" >
                        ...
                        <div class="list">
                            <form class="form-horizontal" id="applyrepair_form">
                                <div class="control-group">
                                    ...
                                    <div class="textarea">
                                        <input type="hidden" id="teacherUserId" name="teacherUserId" value="${accommodation.teacherUserId}"/>
                                        <input readonly  type="button" id="teacherName"  name="teacherName" style="width:800px;height:100px;" value="${accommodation.teacherName}"/>
                                    </div>
                                </div>
                                <div class="x-up">
                                    <div class="control-group">
                                        ...
                                        <input type="text" id="shangBaoTime" name="shangBaoTime" class="chzn-select" autocomplete="off"
                                               style="width:200px;padding-top: 4px;" readonly
                                               value="${accommodation.shangBaoTime}"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div>
                                            <input type="text" value="${accommodation.fangshiHao}" id="fangshiHao"  name="fangshiHao"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                            房屋面积<span style="color:red">*</span>
                                        </label>
                                        <div>
                                            <input type="text" id="area" value="${accommodation.area}"  name="area"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                            冷水度数<span style="color:red">*</span>
                                        </label>
                                        <div>
                                            <input type="text" value="${accommodation.coldWater}" id="coldWater"  name="coldWater"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                            热水度数<span style="color:red">*</span>
                                        </label>
                                        <div>
                                            <input value="${accommodation.hotWater}" type="text" id="hotWater"  name="hotWater"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                            用电度数<span style="color:red">*</span>
                                        </label>
                                        <div>
                                            <input type="text" value="${accommodation.electricity}" id="electricity"  name="electricity"/>
                                        </div>
                                    </div>
                                    <%--详情    --%>
                                    <div class="control-group">
                                        ...
                                        <div class="left">
                                            <div class="textarea">
                                                <textarea style="width:200px;height:100px;padding-top: 4px;"  type="text" id="tontent" name="tontent" class="span4" autocomplete="off">${accommodation.tontent}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div id="coldPictureUUid" style="display:inline-block;">
                                                <c:forEach items="${accommodation.lenshuiMap}" var="item" varStatus="i">
                                                    <div class="img_1"  style="margin: 5px;">
                                                        <a onclick="reMove(this);">X</a>
                                                        <input type="hidden" name="lenshui" value="${item.uuid}"/>
                                                        <img style="width:233px;height:130px;" class="ims" onclick="change(this);" src="${item.url}"/>&nbsp;&nbsp;&nbsp;
                                                    </div>
                                                </c:forEach>
                                            </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div id="hotPictureUUid" style="display:inline-block;">
                                                <c:forEach items="${accommodation.reshuiMap}" var="item" varStatus="i">
                                                    <div class="img_1"  style="margin: 5px;">
                                                        <a onclick="reMove(this);">X</a>
                                                        <input type="hidden" name="reshui" value="${item.uuid}"/>
                                                        <img style="width:233px;height:130px;" class="ims" onclick="change(this);" src="${item.url}"/>&nbsp;&nbsp;&nbsp;
                                                    </div>
                                                </c:forEach>
                                            </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div id="electricityUUid" style="display:inline-block;">
                                                <c:forEach items="${accommodation.dianbiaoMap}" var="item" varStatus="i">
                                                    <div class="img_1"  style="margin: 5px;">
                                                        <a onclick="reMove(this);">X</a>
                                                        <input type="hidden" name="dianbiao" value="${item.uuid}"/>
                                                        <img style="width:233px;height:130px;" class="ims" onclick="change(this);" src="${item.url}"/>&nbsp;&nbsp;&nbsp;
                                                    </div>
                                                </c:forEach>
                                            </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div id="fujianUUID" style="display:inline-block;">
                                                <c:forEach items="${accommodation.fujianMap}" var="item" varStatus="i">
                    ...
                    <p class="tc" style="padding-top:8px;border-top: #ccc 1px solid;"><button class="btn btn-success" type="button" style="margin:0 15px;" onclick="saveOrUpdate();">确定</button>
                        <input type="hidden" id="idss" value="${accommodation.id}"/>
                    </p>
                </div>
            </div>
        </div>
   ...
   */
    function fujianUploader() {
        $('#fujianUploader').uploadifive({
            ...
            'onUploadComplete': function (file,data) {
                var $jsonObj = eval("(" + data + ")");
                var img = '<div id="div_'+$jsonObj.uuid+'"><input type="text" style="display:none;" name="fujianUuid" class="fujianUuid" value="'+$jsonObj.uuid+'" /><a href="'+$jsonObj.uuid+'">'+$jsonObj.realFileName+'</a><button onclick="chehui(div_'+$jsonObj.url+')" type="button">撤销</button></div>';
...
<script type="text/javascript">
    ...
    function saveOrUpdate() {
        ...
        if(panduans=='true'){
            var url="/accomm/zhusu/updateHomeWoke";
            loader.show();
    ...
    function panduan(val) {
        ...
        if(val.area==null || val.area==""){
            return "房屋面积不能为空";
        }
        if(val.hotWater==null || val.hotWater==""){
            return "热水度数不能为空";
        }
        if(val.coldWater==null || val.coldWater==""){
            return "冷水度数不能为空";
        }
        if(val.electricity==null || val.electricity==""){
            return "电表度数不能为空";
        }
        if(val.hotPictureUUid==null || val.hotPictureUUid==""){
            return "热水图片不能为空";
        }
        if(val.coldPictureUUid==null || val.coldPictureUUid==""){
            return "冷水图片不能为空";
        }
        if(val.electricityUUid==null || val.electricityUUid==""){
            return "电表图片不能为空";
        }
        return "true";
    }
