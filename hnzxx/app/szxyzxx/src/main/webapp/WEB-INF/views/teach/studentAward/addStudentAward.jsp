					...
					<form class="form-horizontal tan_form" id="studentaward_form" class="form-horizontal left-align form-well" novalidate="novalidate">
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<select id="awardContent" name="awardContent" class="chzn-select" style="width:220px;"  style="width:220px;"></select>
								</div>
							...
							<div class="control-group">
								...
								<div class="controls">
								 ...
								 <textarea rows="3" cols=""  name="remark" id="remark"  placeholder="备注" style="width:220px;">${studentaward.remark}</textarea>
