...
<body>
	<div class="container-fluid">
		<%-- <jsp:include page="/views/embedded/navigation.jsp">
			...
			<jsp:param value="历史典故" name="title" />
		...
		<div class="row-fluid">
						...
						<div class="widget-head">
							<div class="select_top">
								<div class="s1 s1_bg">
									...
									<div class="click">
										<button class="btn btn-warning" type="button" onclick="loadCreatePage();">上传视频</button>
									</div>
								</div>
							</div>
						</div>												
			...
			<div>			
				...
				<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
					...
					<jsp:param name="url" value="/bbx/bpBwFile/Allusion/index?sub=list&dm=${param.dm}" />
...
<script type="text/javascript">
	$(function(){
		// 		操作按钮
		$(".qx_btn input").click(function(){
			    if(this.checked){   
			    	$(".lsdg .lsdg_list ul li a b").show();
			    }else{   
			    	$(".lsdg .lsdg_list ul li a b").hide();
			    }   
		});
		$(".lsdg .lsdg_list ul li a").click(function(){
	...
	function loadCreatePage() {
		$.initWinOnTopFromLeft_bbx('上传视频', '${ctp}/bbx/bpBwFile/Allusion/creator?objectType=3', '1200', '700');
	}
