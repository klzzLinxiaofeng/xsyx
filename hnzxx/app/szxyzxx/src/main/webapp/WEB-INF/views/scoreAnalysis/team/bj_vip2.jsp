	...
	<body>
		<div>
			...
			<div class="xsxx mgb12">
				 <p>
				 	<span>姓名：<b>${userTeamExam.studentName}</b></span><span>学号：<b>${userTeamExam.number }</b></span>
			...
			<div class="ztqk mgb12 mokuai">
				...
				<table class="ztqk">
					...
					<tbody>
						<tr>
							<td>你的分数</td><td>${userTeamExam.score}</td>
						</tr>
						<tr>
							<td>你的名次</td><td>${userTeamExam.team_rank}</td>
						</tr>
						<tr>
							<td>均分</td><td>${userTeamExam.average_score}</td>
						</tr>
					</tbody>
				</table>
			</div>
		...
		$(function(){
			//班级名次分布线
		    var info = "<span style='font-weight: bold;'>${userExamWork.studentName}</span>&nbsp;<span> 总分${userExamWork.score}</span>&nbsp;&nbsp;&nbsp;<span>排名${userExamWork.team_rank}</span>";
		  ...
		  //班级分数对比图
			...
			series: [{
			    ...
			    color:'rgb(60,211,173)',
			        data: [${userExamWork.highest_score}]
			    }]
			});		
