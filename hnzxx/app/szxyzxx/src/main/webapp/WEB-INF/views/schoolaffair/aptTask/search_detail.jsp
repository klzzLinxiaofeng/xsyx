...
<body>
	...
	<jsp:include page="/views/embedded/navigation.jsp">
			...
			<jsp:param value="个人考核查询" name="title" />
...
<!-- 				</div> -->
				...
				<div class="xs_div" style="width:100%">
					...
					<div class="xs_list">
						...
						<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
								...
								<jsp:param name="url" value="/schoolAffair/aptTask/searchDetail?sub=list&dm=${param.dm}" />
	...
	function search(taskItemId){
		...
		if(taskItemId == null || taskItemId + "" == "undefined" || taskItemId == ""){
			var taskItemId = $(".fenban_left .bottom .bj_rs .ban_ul li a.on").attr("data-id");
		}
...
// 		alert(JSON.stringify(val));
		...
		var url = "/schoolAffair/aptTask/searchDetail?sub=list&dm=${param.dm}";
...
// 			initCount();
	...
	function loadExportPage(){
		var taskId = "${task.id}";
		$.initWinOnTopFromLeft('导出', '${ctp}/schoolAffair/aptTask/loadExport?type=own&taskId=' + taskId, '850', '700');
	}
	$(function(){
