...
<jsp:include page="new_head.jsp"></jsp:include>
    <div style="background-color: #f5f5f8">
        ...
        <div class="man_right" style="margin-left:250px;">
            <iframe src="" allowFullScreen marginheight="0" marginwidth="0" frameborder="0" scrolling="yes" width="100%" id="core_iframe" name="core_iframe"></iframe>
        </div>
    </div>
</div>
