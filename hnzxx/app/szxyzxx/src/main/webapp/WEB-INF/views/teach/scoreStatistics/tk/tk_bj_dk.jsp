...
<div class="kwgl">
    ...
    <div class="pd20">
        ...
        <div class="kwgl_main">
            ...
            <div id="container6" style="min-height: 400px; height: 500px; max-width: 920px; margin: 0 auto"></div>
        </div>
        <div class="kwgl_main">
    ...
    $(function(){
        $('.njfx_km a').click(function(){
            ...
            window.location.href="${pageContext.request.contextPath}/teach/scoreStatistics/analysis/team" +
                "?examWorksId=${examWorksId}&gradeId=${gradeId}&teamId=${teamId}&sub=3&subjectCode=" + subjectCode;
        });
        ...
        /*container6  */
        var class_num=${teamScoreMap.noPassCountList}.length;
        ...
        $('#container6').highcharts({
            ...
            series: [   {
                name: '不及格率',
                data: ${teamScoreMap.noPassCountList}
            },{
                name: '及格率',
                data: ${teamScoreMap.passCountList}
            },{
                name: '良好率',
                data: ${teamScoreMap.lowCountList}
            },{
                name: '优秀率',
                data: ${teamScoreMap.highCountList}
            }]
        });
