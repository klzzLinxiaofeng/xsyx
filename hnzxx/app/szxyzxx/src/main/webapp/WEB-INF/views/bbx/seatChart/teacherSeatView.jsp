...
.cishu p{
	color:#333;line-height: 45px;font-size: 14px;font-family: 微软雅黑;margin: 0;
}
.shu{
	color: #00a0e9;
font-family: '微软雅黑';
...
<script type="text/javascript">
	...
	function setSeatChartSize(){
		...
		$.confirm("座位表将会清空？确定执行此次操作？", function() {
			$.initWinOnTopFromLeft('分配座位', '${pageContext.request.contextPath}/clazz/seatChart/setSeatSize?seatId='+seatId, '600', '300');
		});
	}
