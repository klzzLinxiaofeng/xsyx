...
<div class="kwgl">
    <div class="return_kw">
        <div class="njtk">
            <a href="javascript:void(0)" onclick="goGrade();">年级统考</a>
    ...
    <div class="tk_div">
        <div class="pd20">
            <div class="kw_select">
                ...
                <select id="schoolTerm1" onchange="search()"></select>
            </div>
            <div class="kwgl_main">
                <div class="ks_list" style="padding:20px;">
                    <span>我的班级：<select id="team" onchange="search()"></select></span>
...
<script>
    ...
    function goGrade(){
        window.location.href="${pageContext.request.contextPath}/teach/scoreStatistics/exam/index?isJoint=true";
    }

    function toStudent(id, teamId) {
    ...
    function toTeam(id, teamId){
        window.location.href="${pageContext.request.contextPath}/teach/scoreStatistics/analysis/team/xc?examWorksId=" + id + "&teamId=" + teamId;
    }
