...
<body>
     <div class="container-fluid">
           <jsp:include page="/views/embedded/navigation.jsp">
                ...
                <jsp:param value="作业查看" name="title" />
                                    ...
                                    <iframe allowFullScreen="true"  id="pdfPlayer" name="pdfPlayer" src="<c:url value="/res/plugin/pdf/ROOT/web/viewer.html" />?file=<c:url value="" />" width="786" style="min-height:599px;display:none" scrolling=no></iframe>
                                     ...
                                     <div class="add_fj">
                                           ...
                                           <div class="add_nr">
                                                ...
                                                <div><textarea id="content1" rows="" cols="" class="p2" >${content }</textarea></div>
                                           </div>
                                      <div class="text_num">还可以输入<span style="color: red;" id="title-counter">500</span>字
                                           <div class="text_num"><span style="color: red;" id="title-counter"></span>
                                           <button onclick="saveHomework()" class="btn btn-warning">提交</button></div>
                                               
                                           <input type="hidden" id="fjId" value=""/>
                                     </div>
                                      <div id="fj" style="display:inline-block;"></div>
                                     <div>
                                           <div class="clear"></div>
                                     </div>
                                     </div>
...
//         alert(resId + "_" + resType + "_" + title);
      ...
      function downloadRes(id){
       ...
       function saveRecord(finishedFlag,url) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/homeworkpublish/saveRecord",
                    type: "POST",
                    data: data,
                    async: false,
      ...
      function saveHomework(){
       ...
       var url = "${pageContext.request.contextPath}/homeworkpublish/saveRecord";
       var data = {};
       data.microId = "${res.resEnt.objectId}";
...
//                                   fileTypeExts : "*.*", //默认*.*
                                     ...
                                     onUploadSuccess : function(file, data, response) {
                                           ...
                                           var file ='<div><span style="border: 1px solid #aaa;padding:3px;display:inline-block;margin:5px 0;line-height: 20px;"><a class="text_name" href="' + $jsonObj.url +'">' + $jsonObj.realFileName +
