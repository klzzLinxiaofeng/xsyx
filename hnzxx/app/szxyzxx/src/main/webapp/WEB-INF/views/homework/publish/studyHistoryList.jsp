...
<c:forEach items="${recordList}" var="record">
    <tr>
        ...
        <td class="caozuo">
            <a href="${pageContext.request.contextPath}/homeworkpublish/play?microPublishedId=${record.mlrv.publishMicroLessonId}">查看作业</a>
            <c:if test='${not empty record.mpr.reviews}'>
                <a onclick="watchReviews('${record.mlrv.publishMicroLessonId}','${record.mpr.userId}')" href="javascript:void(0)">查看解答</a>
            </c:if>
        </td>
    </tr>
</c:forEach>
