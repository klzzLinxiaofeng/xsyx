        ...
        <div class="span12">
            <div class="content-widgets white">
                <div class="widget-head">
                    ...
                    <c:if test="${type==2}">
                        <h3 class="x-head content-top"><a href="javascript:void(0);" class="on">教赛详情</a><a href="javascript:history.go(-1);" class="back right"><i class="fa fa-arrow-circle-left"></i>返回</a></h3>
                    </c:if>
                </div>
                        ...
                        <div class="list">
                            <form class="form-horizontal" id="applyrepair_form">
                                <div class="control-group">
                                    ...
                                    <div>
                                        <input type="text" readonly id="theme" value="${classLunWen.theme}" name="theme"  placeholder="请输入标题，少于20个中文字符" class="span6 left-stripe {required : true,maxlength:40}"/>
                                    </div>
                                </div>
                                <div class="x-up">
                                    <div class="control-group">
                                        ...
                                        <div>
                                            <input style="position:relative;top:-12px;" readonly value="${classLunWen.type}" type="text" id="types" name="types"  class="span3 left-stripe {maxlength:500}"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                        ...
                                        <div>
                                            <input style="position:relative;top:-12px;" readonly value="${classLunWen.shuXing}" type="text" id="shuXing" name="attractName"  class="span3 left-stripe {maxlength:500}"/>
                                        </div>
                                    ...
                                    <c:if test="${type==1}">
                                        <div class="control-group">
                                            ...
                                            <div class="left">
                                                <div class="textarea">
                                                    <textarea id="huojiangStudent" readonly name="huojiangStudent" style="width:800px;height:100px;">${classLunWen.studentNames}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </c:if>
                                    <div class="control-group">
                                        ...
                                        <div class="left">
                                            <div class="textarea">
                                                <textarea  id="huojiangTeacher" readonly name="huojiangTeacher" style="width:800px;height:100px;">${classLunWen.teacherNames}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div>
                                            <input style="position:relative;top:-12px;" readonly type="text" id="attractName" value="${classLunWen.nameWoke}" name="attractName"  class="span3 left-stripe {maxlength:500}"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                        ...
                                        <div>
                                            <input style="position:relative;top:-12px;" readonly type="text" id="huojiangjibie" value="${classLunWen.winningLevelName}" name="huojiangjibie"  class="span3 left-stripe {maxlength:500}"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                        ...
                                        <div>
                                            <input style="position:relative;top:-12px;" readonly type="text" id="dengci" value="${classLunWen.dengciName}" name="dengci"  class="span3 left-stripe {maxlength:500}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <input type="text" readonly id="huojiangTime" name="huojiangTime" class="chzn-select" autocomplete="off"
                                               ...
                                               value="${classLunWen.winningTime}">
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label">发奖单位</label>
                                        <div>
                                            <input style="position:relative;top:-12px;" readonly type="text" id="fajiangDanwei" name="fajiangDanwei" value="${classLunWen.allocated}" class="span3 left-stripe {maxlength:500}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                        ...
                                        <div class="controls">
                                            <div id="zpa" style="display:inline-block;">
                                                <c:forEach items="${classLunWen.pictureList}" var="item" varStatus="i">
                                                ...
                                                <c:if test="${classLunWen.pictureList.size()<=0}">
                                                    暂无图片
                                                </c:if>
                                            </div>
                                        </div>
