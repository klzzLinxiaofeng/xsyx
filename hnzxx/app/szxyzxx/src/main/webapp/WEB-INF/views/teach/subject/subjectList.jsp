...
<body>
	<div class="container-fluid">
		<jsp:include page="/views/embedded/navigation.jsp">
			...
			<jsp:param value="科目管理" name="title" />
						...
						<div class="widget-container">
							<div class="select_b">
								<div class="select_div">
									<span>科目名称：</span><input type="text" id="name" name="name" 
									data-id-container="name" style="margin-bottom: 0;  width: 120px; margin-right: 3px;"
...
<%-- 							<jsp:param name="url" value="/teach/subject/subjectList?sub=list" /> --%>
