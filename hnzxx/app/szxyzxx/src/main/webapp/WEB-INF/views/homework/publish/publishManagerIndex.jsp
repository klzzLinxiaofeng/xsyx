...
<html>
                        ...
                        <div class="content-widgets">
                            <div class="widget-container">
                                ...
                                <jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
                                    ...
                                    <jsp:param name="url" value="/homeworkpublish/publishManager" />
    ...
    <script type="text/javascript">
                                                    function changeClass(classId,relateType) {
                                                        ...
                                                        var url = "/homeworkpublish/publishManager";
                                                    ...
                                                    function resetDate(mid, startDate, finishedDate) {
                                                        ...
                                                        $.initWinOnTopFromLeft(mes, '${pageContext.request.contextPath}/homeworkpublish/resetDate?publishId=' + mid + '&relateId=' + relateId + '&startDate=' + startDate + '&finishedDate=' + finishedDate, '700', '190');
                                                    }

                                                    function deletePublish(mid) {
                                                        $.confirm("确定删除这条已发布的作业吗?", function() {
                                                            $.ajax({
                                                                url: "${pageContext.request.contextPath}/homeworkpublish/deletePublished",
                                                                type: "POST",
                                                                data: {"publishId": mid, "relateId": $(".kemu .active").attr("id").split("_")[1]},
                                                                async: false,
                                                                success: function(html) {
                                                                    location.href = "${pageContext.request.contextPath}/homeworkpublish/publishManagerIndex?relateId=" + $(".kemu .active").attr("id").split("_")[1];
                                                                }
                                                            });
                                                        });
                                                    }
