...
<body>
	<div class="container-fluid">
		<jsp:include page="/views/embedded/navigation.jsp">
			...
			<jsp:param value="社会实践" name="title" />
			...
			<div class="span12">
				<div class="content-widgets white">
						...
						<h3>
							...
							<p class="btn_link" style="float: right;">
								...
								<a href="javascript:void(0)" class="a4"
									onclick="loadCreatePage();"><i class="fa fa-plus"></i>添加实践</a>
								</c:if>
							</p>
						</h3>
					</div>
					...
					<div class="content-widgets">
						...
						<form class="form-horizontal tan_form" id="practice_index" action="javascript:void(0);">
							<div class="select_b">
							...
							<table class="responsive table table-striped" id="data-table">
								...
								<tbody id="practice_list_content">
									<jsp:include page="./list.jsp" />
								</tbody>
							</table>
							<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
								<jsp:param name="id" value="practice_list_content" />
								<jsp:param name="url" value="/teach/practice/index?sub=list&dm=${param.dm}" />
...
<script type="text/javascript">
	...
	function initValidator() {
		return $("#practice_index").validate({
			errorClass : "myerror",
			rules : {
				"startDate":{
	...
	function search() {
		if (checker.form()) {
			...
			var id = "practice_list_content";
			var url = "/teach/practice/index?sub=list&dm=${param.dm}";
	...
	function loadCreatePage() {
		$.initWinOnTopFromLeft('创建', '${ctp}/teach/practice/creator', '1000', '580');
	}
	//  加载编辑对话框
	function loadEditPage(id) {
		$.initWinOnTopFromLeft('编辑', '${ctp}/teach/practice/editor?id=' +id, '1000', '580');
	}
	
	function loadViewerPage(id) {
		$.initWinOnTopFromLeft('详情', '${ctp}/teach/practice/editor?id=' + id + "&isCK=disable", '1000', '580');
	}
	...
	function executeDel(obj, id) {
		$.post("${ctp}/teach/practice/" + id, {"_method" : "delete"}, function(data, status) {
			if ("success" === status) {
				if ("success" === data) {
					$.success("删除成功");
					$("#" + id + "_tr").remove();
