...
$(function () {
    ...
    function studentStatisticsTemp(){
    	document.getElementById("studentStatisticsForm").submit();
    }
...
<body>
	<div class="container-fluid">
		<jsp:include page="/views/embedded/navigation.jsp">
			...
			<jsp:param value="学生统计分析" name="title" />
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="content-widgets white">
					...
					<form action="${pageContext.request.contextPath}/teach/studentStatistics/getStudentStatistics" id="studentStatisticsForm">
...
<!-- 							<button onclick="studentStatisticsTemp();" type="button" class="btn btn-warning">确定</button> -->
