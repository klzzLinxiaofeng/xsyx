...
<c:choose>
	<c:when test="${!empty tdInfoList }">
		...
		<div class="txl_list">
			<ul id="all_workmates_list">
				<jsp:include page="./allMail_list.jsp" />
			</ul>
			<div style="margin-top:23%; width:87%;">
				<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
					<jsp:param name="id" value="all_workmates_list" />
					<jsp:param name="url"
						value="/office/ajax/allMail/allMail_index?sub=allMail_list&dm=${param.dm}" />
