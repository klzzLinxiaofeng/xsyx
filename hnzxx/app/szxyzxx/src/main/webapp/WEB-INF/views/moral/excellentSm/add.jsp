        ...
        <div class="content-widgets" style="margin-bottom: 0">
            <div class="widget-container" style="padding: 20px 0 0;">
                <form class="form-horizontal tan_form" id="publicClass_form"  enctype="multipart/form-data" action="javascript:void(0);">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">名额<span style="color: red">*</span></label>
                        <div class="layui-input-block">
                            <input  type="number" name="passNum" id="passNum" style="height: 27px;">
                        </div>
                    </div>
