				...
				<div class="content-widgets white">
					<div class="widget-head">
						<h3 class="jc_top">
							...
							<p class="btn_link" style="float: right;margin:0">
								<a href="${ctp}/teach/textBookMaster/textBook/index?sub=resFirst" class="a3"
									onclick=""><i class="fa  fa-check-circle"></i>设为校本</a>
					...
					<div class="content-widgets">
							...
							<jsp:include page="/views/embedded/jqpagination.jsp" flush="true">
								...
								<jsp:param name="url" value="/teach/textBookMaster/resTextBook/index?sub=list&dm=${param.dm}" />
...
<script type="text/javascript">
	...
	function search() {
		...
		var url = "/teach/textBookMaster/resTextBook/index?sub=list&dm=${param.dm}";
	...
	function loadCreatePage() {
		...
		$.initWinOnTopFromLeft('创建', '${ctp}/teach/textBookMaster/resTextBook/creator', '1000', '800');
	}
	//  加载编辑对话框
	function loadEditPage(id) {
		$.initWinOnTopFromLeft('教材编辑', '${ctp}/teach/textBookMaster/resTextBook/editor?id=' + id, '700', '700');
	}
	//教材基本信息显示
	...
	//将设为校本的教材从校本资源库删除
	function canelTextBookToSchool(uuid, id) {
		$.ajax({  
			type:"DELETE",  
			url:"${ctp}/teach/textBookMaster/resTextBook/"+id+"/"+1,
	...
	function loadViewerCatalogPage(id) {
		var url = "${ctp}/teach/textBookMaster/resTextBookCatalog/resCatalogList?textBookId=";
		 url = url+id;
	...
	function executeDel(obj, id) {
		$.post("${ctp}/teach/textBookMaster/resTextBook/" + id + "/0", {"_method" : "delete"}, function(data, status) {
			if ("success" === status) {
				if ("success" === data) {
					$.success("删除成功");
					$("#" + id + "_tr").remove();
	...
	function findTextBook(name) {
		 var selectVal = '#'+name;
		  $(selectVal).empty();
			 $.ajax({  
				type:"post",  
				url:"${ctp}/teach/textBookMaster/resTextBook/findTextBookNoHidden",  
				data:{
