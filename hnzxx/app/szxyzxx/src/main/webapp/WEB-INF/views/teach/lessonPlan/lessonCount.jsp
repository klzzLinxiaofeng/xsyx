...
function getCountDataByTeacher($parameters){
	$.post("${ctp}/generalTeachingAffair/lessonplan/countByTeacher", $parameters,function(returnData, status) {
		if ("success" === status) {
			var tableHtml = "";
			var allNumber = 0;
			var index = 0;
...
function getCountDataBySubject($parameters){
	$.post("${ctp}/generalTeachingAffair/lessonplan/getTeacherSubjectData", $parameters,function(returnData, status) {
		if ("success" === status) {
...
function getCountDataByGrade($parameters){
	...
	$.post("${ctp}/generalTeachingAffair/lessonplan/findCountNumberByGrade", $parameters,function(returnData, status) {
...
<body>
	<div class="container-fluid">
		<jsp:include page="/views/embedded/navigation.jsp">
			...
			<jsp:param value="教案统计" name="title" />
