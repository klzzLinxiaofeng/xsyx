                ...
                <form class="form-horizontal tan_form" id="publicClass_form"  enctype="multipart/form-data" action="javascript:void(0);">
                    ...
                    <div class="control-group">
                        <label class="control-label">
                            大课间评分结果明细表<span style="color: red">*</span>
                        </label>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">所属日期<span style="color: red">*</span></label>
                        <div class="layui-input-block">
                            <input type="text" id="date" name="ofDate"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate: '%y-%M-%d'});" style="height: 27px;" />
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label class="layui-form-label">所属学期月<span style="color: red">*</span></label>
                        <div class="layui-input-block">
                            <input  type="number" name="xqy" id="xqy" style="height: 27px;">
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label class="layui-form-label">所属学期周<span style="color: red">*</span></label>
                        <div class="layui-input-block">
                            <input  type="number" name="xqz" id="xqz" style="height: 27px;">
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function sub(){
        ...
        if($("#date").val()==""){
            layer.alert("请选择表格所属日期");
            return false;
        }

        if(parseInt($("#xqz").val())<1){
            layer.alert("学期周有误");
            return false;
        }

        if(parseInt($("#xqy").val())<1){
            layer.alert("学期月有误");
            return false;
        }
