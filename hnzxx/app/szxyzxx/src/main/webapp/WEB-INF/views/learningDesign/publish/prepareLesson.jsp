    ...
    <body>
        <div class="container-fluid">
            <jsp:include page="/views/embedded/navigation.jsp">
                ...
                <jsp:param value="布置课件" name="title" />
                        ...
                        <div class="widget-container">
                            <form id="dept_form" class="form-horizontal" novalidate="novalidate">
                                                                ...
                                                                <c:forEach items="${cm.value}" var="teamMap">
                                                                    <c:forEach items="${teamMap}" var="team">
                                                                         <li style="font-size: 14px;">
                                                                            <input data-type="${fn:split(team.value,'&&')[1]}" value="${team.key}" onclick="checkClassSubject(this)" type="checkbox" style="width:16px;height:16px;"/>
                                ...
                                <div id="microMainDiv" class="control-group">
                                    <label class="control-label"><font style="color:red">*</font>课件</label>
                                    <div class="controls">
                                        <div class="banji">
                                            <ul class="nj">
                                           ...
                                           <div class="back_tj">
                                            ...
                                            <div class="ts">
                                                ...
                                                <div onclick="publishLesson();" class="btn btn-danger">布置已选课件</div>
        ...
        <script type="text/javascript">
		        ...
		        function chose(dataType){
		            ...
		            if(dataType == "myresource"){//我上传的资源
			        	url = url + "/learningDesignpublish/myResource?index=index&resType=2&personType=res_person";
		            }else if(dataType == "favresource"){//我收藏的资源
		            	url = url + "/learningDesignpublish/favResource?index=index&resType=2&personType=fav_resource";
		            }else if(dataType == "myshare"){//我的共享
		            	url = url + "/learningDesignpublish/myResource/myShare?index=index&resType=2&personType=res_share";
		            }
		        	$(".weike").load(url,function(){});
                                            ...
                                            function changeMicroTab(type) {
                                                ...
                                                if (type == "myMicro") {
                                                    ...
                                                    url = url + "/resource/searcher/index?isPublish=1&stageCode=2&subjectCode="+subjectCode+"&gradeCode="+gradeCode+"&resType=<%=ResourceType.LEARNING_DESIGN%>";
                                                    source = "来自公共资源库";
                                	                ...
                                	                var subjectCode = $(".fenban input[type='checkbox']").first().next().val();
                                	                var gradeCode = $(".nj .active input[type='hidden']").val();
                                	                url = url + "/resource/searcher/index?isPublish=0&stageCode=2&subjectCode=" + subjectCode + "&gradeCode=" + gradeCode + "&resType=<%=ResourceType.LEARNING_DESIGN%>";
                                	                source = "来自校本资源库";
                                	                $(".kemu_nav").css("display","none");
                                	                $(".back_tj").css({"float":"right","width":"auto"})
                                	            } else if (type == "upload") {
                                            ...
                                            function publishLesson() {
                                                ...
                                                loader.show();
                                                $.ajax({
                                                    url: "${pageContext.request.contextPath}/learningDesignpublish/publishLesson",
                                                    type: "POST",
                                                    ...
                                                    success: function() {
                                                        ...
                                                        location.href = "${pageContext.request.contextPath}/learningDesignpublish/publishManagerIndex?relateId="+relateId+"&relateType="+relateType;
                                                    }
                                                });
                                            }
