			...
			<div class="widget-container" style="background-color:#F8F8F8">
				<form class="form-horizontal" id="setting_form" style="padding-bottom:0;margin-bottom:0">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input id="lessonOfMorning" type="text" name="lessonOfMorning" class="span1 lesson" placeholder="请输入上午节数" value='${item.lessonOfMorning}'
					...
					<div class="form-actions" style="border-top:0 none;background-color:#f8f8f8;margin-left: 300px;margin-bottom:0px;margin-top:0px;padding-top:0;">
						<button class="btn btn-warning" type="button"
							onclick="editorSetting();">确定</button>
					</div>
				</form>
