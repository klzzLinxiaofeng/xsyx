...
//             nextLabel: 'Next',
    ...
    layui.use('upload', function(){
        ...
        var uploadInst = upload.render({
            elem: '#upFile' //绑定元素
            ,url: '${pageContext.request.contextPath}/pingyumoban/upLoadPingYuScore' //上传接口
        ...
        if (listSuccess.length == 0) {
            ...
            for (var i = 0, len = listSuccess.length; i < len; i++) {
                $("#successResultId").append("<tr id='data"+i+"'>" +
                    ...
                    "<td>"+listSuccess[i]['schoolTrem']+"</td>" +
                    "<td>"+listSuccess[i]['gradeName']+"</td>" +
                    "<td>"+listSuccess[i]['subjectName']+"</td>" +
                    "<td>"+listSuccess[i]['mobanTypeName']+"</td>" +
                    "<td>"+listSuccess[i]['literacy_name']+"</td>" +
                    "<td>"+listSuccess[i]['startScore']+"</td>" +
                    "<td>"+listSuccess[i]['endScore']+"</td>" +
                    "<td>"+listSuccess[i]['context']+"</td>" +
        ...
        if(listFail.length == 0){
            ...
            for(var k = 0, lenTemp = listFail.length; k < lenTemp; k++){
                $("#failResultId").append("<tr id='data2"+k+"'>" +
                    ...
                    "<td>"+listFail[k]['schoolTrem']+"</td>" +
                    "<td>"+listFail[k]['gradeName']+"</td>" +
                    "<td>"+listFail[k]['subjectName']+"</td>" +
                    "<td>"+listFail[k]['mobanTypeName']+"</td>" +
                    "<td>"+listFail[k]['literacy_name']+"</td>" +
                    "<td>"+listFail[k]['startScore']+"</td>" +
                    "<td>"+listFail[k]['endScore']+"</td>" +
                    "<td>"+listFail[k]['context']+"</td>" +
