	...
	$(function() {
		...
		$.initNBSCascadeSelector({
			...
			"stuSelectId" : "studentId",  //学生select标签ID 默认为stu
 			"isEchoSelected" : true,
			"gradeSelectedVal" : "${healthStudentHealing.gradeId}", //要回显的年级唯一标识
			"teamSelectedVal" : "${healthStudentHealing.teamId}", //要回显的班级唯一标识
			"stuSelectedVal" : "${healthStudentHealing.studentId}" //要回显的学生唯一标识 
		});
		
		//性别
		$.jcGcSelector("#sex", {tc : "GB-XB"}, "${healthStudentHealing.sex}", function() {});
