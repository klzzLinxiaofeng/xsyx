            ...
            <div class="widget-container" style="padding: 20px 0 0;">
                <form class="form-horizontal tan_form" id="publicClass_time_form" action="javascript:void(0);">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled id="nj" name="gradeId" class="span4"
...
<script type="text/javascript">
    ...
    function saveOrUpdate() {
        ...
        var url = "${ctp}/indicators/input/update";
    ...
    function initSelect() {
        //初始填充学年、学期、年级
        addOption('/teach/schoolYear/list/json', "xn", "year", "name",${indicatorsPojo.schoolYear}, function (d) {
            var  d = JSON.parse(d);
            if (d.length > 0) {
                //因查询年级不需学期，所以不需在学期填充后的回调中执行
                addOption('/teach/grade/list/json?schoolYear=' + d[0].year, "nj", "id", "name",${indicatorsPojo.gradeId})
            }
        })
