    ...
    <div class="pd20">
        ...
        <div class="nj_basis_info">
            ...
            <div class="color_kuai">
                ...
                <div class="ck2">
                    <p class="ck_num"><span>${scoreMap.avgScore}</span>/<span>${scoreMap.totalFullScore}</span></p>
                    <p class="ck_info">年级总分平均分</p>
                </div>
                <div class="ck3">
                    <p class="ck_num"><span>${scoreMap.highestScore}</span>/<span>${scoreMap.totalFullScore}</span></p>
                    <p class="ck_info">年级总分最高分</p>
                </div>
                <div class="ck4">
                    <p class="ck_num"><span>${scoreMap.lowestScore}</span>/<span>${scoreMap.totalFullScore}</span></p>
        ...
        <div class="kwgl_main">
            <p class="title">年级各学科均分雷达图</p>
            <div id="container1" style="height: 500px; width: 920px; margin: 0 auto"></div>
        </div>
        <div class="kwgl_main">
            <p class="title">年级各班级总分平均分排名</p>
            <div id="container2" style="height: 500px; width: 920px; margin: 0 auto"></div>
        </div>
        <div class="kwgl_main">
            <p class="title">年级总分名次分布图</p>
            <div id="container3" style="height: 500px; width: 920px; margin: 0 auto"></div>
        </div>
        <div class="kwgl_main">
            <p class="title">年级总分分数段图</p>
            <div id="container4" style="height: 500px; width: 920px; margin: 0 auto"></div>
        </div>
    </div>
</div>
</body>
...
$(function(){
    ...
    $('#container1').highcharts({
        ...
        xAxis: {
//            categories: ['语文', '数学', '英语', '生物', '化学', '政治','物理'],
...
//            data: [{fs:80,y:20}, {fs:100,y:11}, {fs:220,y:4}, {fs:260,y:3}, {fs:380,y:1}]
    ...
    /*container4  */
    var length = 15;
    var all_score=${scoreMap.totalFullScore};
    var current_score=0;
