...
<html>
    ...
    <script type="text/javascript">
                                            ...
                                            function sendReviews() {
                                                ...
                                                loader.show();
                                                $.ajax({
                                                    url: "${pageContext.request.contextPath}/homeworkpublish/saveReviews",
                                                    type: "POST",
                                                    ...
                                                    success: function() {
                                                        ...
                                                        if (parent.core_iframe != null) {
                                                            parent.core_iframe.window.location.href = "${pageContext.request.contextPath}/homeworkpublish/publishDetails?index=index&microPublishedId=${microPublishId}&relateId=${relateId}&relateType=${relateType}";
                                                        } else {
                                                            parent.window.location.href = "${pageContext.request.contextPath}/homeworkpublish/publishDetails?index=index&microPublishedId=${microPublishId}&relateId=${relateId}&relateType=${relateType}";
                                                        }
                                                        $.closeWindow();
                                                        loader.close();
                                                    }
