...
<div class="container-fluid">
    <jsp:include page="/views/embedded/navigation.jsp">
        <jsp:param name="title" value="班级学校抽检"/>
...
<script type="text/javascript">
    ...
    function getTableOption(){
        ...
        , cols: [[
                ...
                {field: 'cwj', title: '晨午检开展得分', align: 'center'},
    ...
    function addPage() {
        $.initWinOnTopFromLeft('导入班级学校抽检', '/dy/ex/xxcj/addPage', '500', '500');
    }
    ...
    function delCheck(){
        ...
        layer.confirm('确定删除所选数据？', function(index){
            var li=layer.load(2);
            $.post('/dy/ex/xxcj/delete',{ids:ids},function(d){
                layer.close(li);
                layer.close(index);
                d=JSON.parse(d);
                if(d.code==200) {
