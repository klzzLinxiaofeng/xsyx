...
<div class="top">
	<p class="left">
		...
		<a href="javascript:void(0)" data-code="6" class='${param.resType != null && param.resType == "6" ? "on" : ""}'>教材<span><c:if test='${param.resType != null && param.resType == "6"}'>（${param.resourceCount}）</c:if></span></a> 
