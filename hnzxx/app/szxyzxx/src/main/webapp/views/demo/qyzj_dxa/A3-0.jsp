...
<div class="qyzj_header">
	...
	<div class="qyzj_right">
		<ul>
			...
			<li><a href="javascript:void(0)" class="a2 ">我布置的</a></li>
			<li><a href="javascript:void(0)" class="a3 btn-blue">我接收的</a></li>
		</ul>
	</div>
</div>
		...
		<div class="xdkm_div">
			<div class="xd_km">
				<div class="xueduan">
					<label>学年：</label>
					<div class="xd">
						<a href="javascript:void(0)">2016-2017</a>
						<a href="javascript:void(0)" class="btn-blue">2017-2018</a>
					</div>
				</div>
				 <div class="xueduan">
					<label>年级：</label>
				...
				<div class="xueduan">
					...
					<div class="xd">
						...
						<a href="javascript:void(0)" class="btn-blue">二班</a>
