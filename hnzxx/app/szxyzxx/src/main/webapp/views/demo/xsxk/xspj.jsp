...
<div class="container-fluid">
		<jsp:include page="/views/embedded/navigation.jsp">
			...
			<jsp:param value="学生评价" name="title" />
					...
					<div class="content-widgets">
						<div class="widget-container">
							<div class="select_b">
								...
								<div class="select_div">
									<span>状态：</span> <select><option>未开课</option><option>开课中</option><option>选课中</option><option>已结束</option></select>
								</div>
							...
							<table class="responsive table table-striped" id="data-table">
								...
								<tbody id="studentAid_list_content">
									<tr>
										...
										<td>平时成绩+考试</td>
										<td>已结束</td>
										<td><input type="text" style="line-height:25px;height:20px;margin:0;"></td>
										<td><button class="btn btn-blue">保存</button></td>
									</tr>
									<tr>
										<td>一年级</td>
										<td>语文</td>
