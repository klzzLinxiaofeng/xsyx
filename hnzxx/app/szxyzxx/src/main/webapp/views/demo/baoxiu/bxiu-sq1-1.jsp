			...
			<div class="content-widgets white">
				...
				<div class="x-main">
					...
					<div class="clearfix x-mright">
						...
						<p class="clearfix"><span class="left"><i class="fa fa-user"></i>维修人</span><em>李师傅</em></p>
						<p class="clearfix"><span class="left"><i class="fa fa-phone"></i>联系电话</span><em>123143546</em></p>
						<p class="clearfix"><span class="left"><i class="fa fa-clock-o"></i>维修时间</span><em>6月21日16:00</em></p>
						<p class="clearfix"><span class="left"><i class="fa fa-wrench"></i>维修状态</span><em>已经完成</em></p>
						<p class="clearfix"><span class="left"><i class="fa fa-comment-o"></i>备注信息</span><span><em style="color:#2e2e2e;">黑板已经修好了，多余的螺钉在黑板后面。记得保管好。</em><em class="img"><img src="${pageContext.request.contextPath}/res/images/w183.jpg" alt="img"></em></span></p>
