...
<body style="background-color: #e3e3e3;"">
	...
	<div class=" content_main" style="padding: 20px 0 0px;" border-radius: 0;>
		...
		<table class="table" style="border-top: 1px solid #dddddd;">
			...
			<tbody>
				<tr><td><i class="ck jinzhi"></i></td><td>1</td><td>王小明</td><td>男</td><td>小明</td><td>16757837676</td><td></td><td></td><td>在编</td><td class="caozuo"><button class="btn btn-green" onclick="editTeacher()">编辑</button><button class="btn btn-red">删除</button></td></tr>
				<tr><td><i class="ck"></i></td><td>2</td><td>李想</td><td>女</td><td>想想</td><td>16757837676</td><td>艺术部</td><td></td><td>在编</td><td class="caozuo"><button class="btn btn-green" onclick="editTeacher()">编辑</button><button class="btn btn-red">删除</button></td></tr>
				<tr><td><i class="ck"></i></td><td>3</td><td>刘大旭</td><td></td><td></td><td>16757837676</td><td></td><td></td><td>在编</td><td class="caozuo"><button class="btn btn-green" onclick="editTeacher()">编辑</button><button class="btn btn-red">删除</button></td></tr>
				<tr><td><i class="ck"></i></td><td>4</td><td>张不但</td><td></td><td></td><td>16757837676</td><td></td><td></td><td>在编</td><td class="caozuo"><button class="btn btn-green" onclick="editTeacher()">编辑</button><button class="btn btn-red">删除</button></td></tr>
				<tr><td><i class="ck"></i></td><td>5</td><td>吴晓婷</td><td></td><td></td><td>16757837676</td><td></td><td></td><td>在编</td><td class="caozuo"><button class="btn btn-green" onclick="editTeacher()">编辑</button><button class="btn btn-red">删除</button></td></tr>
				<tr><td><i class="ck"></i></td><td>6</td><td>秋衣</td><td></td><td></td><td>16757837676</td><td></td><td></td><td>在编</td><td class="caozuo"><button class="btn btn-green" onclick="editTeacher()">编辑</button><button class="btn btn-red">删除</button></td></tr>
			</tbody>
		</table>
		<div class="page_div">
...
<form id="signupForm" class="form-horizontal" method="get" action="">
	<div class="select_div bkbj">
		...
		<input type="text" id="teachername" name="teachername" disabled="disabled">
	</div>
	<div class="select_div">
		<span>别名：</span>
		<input type="text">
...
function newTeacher(){
	$.initWinOnTopFromLeft_qyjx("新建教师信息",  '${pageContext.request.contextPath}/views/demo/new_school/tis_edit.jsp', '458', '493');	
}
