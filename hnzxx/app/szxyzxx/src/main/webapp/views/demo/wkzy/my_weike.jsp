									...
									<div class="courses-header">
										<div class="left-items">
											<a href="javascript:void(0)" class="show-all-toggle">
												<h4 class="collection-title ellipsis ellipsisWidth">数学</h4>
											</a>
										</div>
												...
												<div>
													...
													<a target="_blank" href="/common/resources/frontMicroCourseAction_play.action?resMicroId=402885823fafe604013fd293c72307b4">
													 ...
													 <span title="金色的草地"
														...
														<span class="share">
														<span id="favorite_402885823fafe604013fd293c72307b4"> 
														<a onclick="onFavoriteProcess('yes', '402885823fafe604013fd293c72307b4');">收藏 </a>
														</span>
