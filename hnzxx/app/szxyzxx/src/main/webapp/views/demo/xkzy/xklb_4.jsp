		...
		<div class="row-fluid">
			<div class="span12">
				<div class="content-widgets white" >
					...
					<div class="kemu_nav">
						<ul>
							<li><a  href="javascript:void(0)">看过的资源</a></li>
							<li><a class="active" href="javascript:void(0)">上传的资源</a></li>
													...
													<dl>
														...
														<dd>
															<div class="item-msg">
																...
																<div class="cz_btn"><a class="bianji">编辑</a><a class="qingchu">删除</a></div>
