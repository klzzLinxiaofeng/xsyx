				...
				<div class="widget-container" style="padding:20px 0 0;">
					<form class="form-horizontal" id="user_form">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="" name="" class="span4" placeholder="当前时间, 不能为空" onclick="WdatePicker();">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">截止页码</label>
							<div class="controls">
								<input type="text" id="" name="" class="span4" placeholder="截止页码, 不能为空" >
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">已看百分比</label>
							<div class="controls">
								<input type="text" id="" name="" class="span4" placeholder="百分比, 不能为空" >
							</div>
						</div>
