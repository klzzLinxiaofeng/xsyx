			...
			<div class="content-widgets" style="margin-bottom:0">
				<div class="widget-container" style="padding:20px 0 0;">
					...
					<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="" name="" class="span4" placeholder="会议名称, 不能为空" >
                            </div>
						</div>
						<div class="control-group">
							<label class="control-label">会议室</label>
							<div class="controls">
								<input type="text" id="" name="" class="span4" placeholder="会议室, 不能为空" >
                            </div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label">解决问题百分比</label>
							<div class="controls">
								<input type="text" id="" name="" class="span4" placeholder="解决百分比" >
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">未解决问题百分比</label>
							<div class="controls">
								<input type="text" id="" name="" class="span4" placeholder="未解决百分比" >
							</div>
						</div>
						<div class="control-group">
