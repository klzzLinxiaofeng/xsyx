		...
		<div class="span12">
			<div class="content-widgets white">
				...
				<div class="clearfix x-mright">
						...
						<div class="clearfix">
							<p><span class="left"><i class="fa fa-comment-o"></i>备注</span><span><em style="color:#2e2e2e;">谢谢李师傅及时修好了黑板。</em><em class="img"><img src="${pageContext.request.contextPath}/res/images/w183.jpg" alt="img"></em></span></p>
