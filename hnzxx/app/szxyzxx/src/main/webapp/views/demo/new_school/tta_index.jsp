...
<body style="background-color: #e3e3e3;" onload="IFrameResize()">
	<div class="sjcsh_xx">
		<a href="javascript:void(0)" id="tta01">教师任课导入</a>
		<a href="javascript:void(0)" id="tta02">教师任课管理</a>
		<a href="javascript:void(0)" id="tta03">科目信息管理</a>
		<a href="javascript:void(0)" id="tta04">年级科目管理</a>
		<a href="javascript:void(0)" id="tta05">科任教师管理</a>
	</div>
	<iframe src="4_0_0_index.jsp" width="100%" frameborder="0" id="iframe_sencond"  scrolling="no"></iframe>
<script>
