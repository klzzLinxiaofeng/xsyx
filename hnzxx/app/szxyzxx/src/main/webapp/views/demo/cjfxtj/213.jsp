...
<div class="kwgl">
	<div class="return_kw">
		...
		<div class="njtk">
			<a href="javascript:void(0)">年级综合分析</a>
			<a href="javascript:void(0)">年级单科分析</a>
			<a href="javascript:void(0)" class="on">年级趋势分析</a>
		</div>
