...
<div class="kwgl">
	...
	<div class="search_result">
		<div class="search_div">
			<p class="title">在校生（<span>2</span>）</p>
			<div>
				<ul>
					<li class="on">
						<a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/res/images/noPhoto.jpg"></a>
						<p class="p1">一年级1班</p>
						<p class="p2">刘小城</p>
					</li>
					<li>
		...
		<div class="search_div">
			<p class="title">毕业生（<span>2</span>）</p>
			<div>
				<ul>
					<li class="on">
						<a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/res/images/noPhoto.jpg"></a>
