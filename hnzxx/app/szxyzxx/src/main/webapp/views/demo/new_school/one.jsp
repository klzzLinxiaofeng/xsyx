...
<body style="background-color: #e3e3e3;" onload="IFrameResize()">
	<div class="sjcsh_xx">
		<a href="javascript:void(0)" class="on" id="teacher_info_import">教师信息导入</a>
		<a href="javascript:void(0)" id="teacher_info_manage">教师信息管理</a>
	</div>
	<iframe src="teacher_info_import_index.jsp" width="100%" frameborder="0" id="iframe_sencond"  scrolling="no"></iframe>
<script>
