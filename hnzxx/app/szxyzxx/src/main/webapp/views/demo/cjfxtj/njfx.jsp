...
<div class="kwgl">
	<div class="return_kw">
		...
		<div class="njtk">
			<a href="javascript:void(0)" class="on"  id="2033">年级成绩单</a>
			<a href="javascript:void(0)" id="210njfx">年级综合分析</a>
			<a href="javascript:void(0)" id="211">年级单科分析</a>
	...
	<iframe src="2033.jsp" id="njfx_iframe" width="100%" height="auto" frameborder="0"></iframe>
</div>
</body>
<script>
$(function(){
