						...
						<div class="video_div">
							<div class="title_1"><p>正在查看: &nbsp; </p>
								<div class="item-title">
									<span class="res-swf icon-file res-iconb" style="margin-top:10px;"></span>
							...
							<div class="play_area_1">
								<img src="${pageContext.request.contextPath}/res/images/video_1.jpg" style="width:786px;height:619px;">
							</div>
							<div class="v_div">
								<div class="fx_left">
									<div class="fx_1">
