...
<div class="analysis" style="background:#fff;">
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td class="project"><p class="name her">上课说闲话</p></td>
                <td>
            ...
            <tr>
                <td class="project"><p class="name her">上课看课外书</p></td>
                <td>
                    <span class="green">5</span>
                    <div  class="schedule">
            ...
            <tr>
                <td class="project"><p class="name her">上课玩小动作</p></td>
                <td>
                    <span class="green">5</span>
                    <div  class="schedule">
                        <p class="green" style="width: 50%;"></p>
            ...
            <tr>
                <td class="project"><p class="name her">不认真写作业</p></td>
                <td>
                    <span class="green">5</span>
                    <div  class="schedule">
                        <p class="green" style="width: 50%;"></p>
            ...
            <tr>
            <td class="project"><p class="name her">上课打瞌睡</p></td>
                <td>
                    <span class="green">5</span>
                    <div  class="schedule">
                        <p class="green" style="width: 50%;"></p>
            ...
            <tr>
            <td class="project"><p class="name her">不上交作业</p></td>
                <td>
                    <span class="green">5</span>
                    <div  class="schedule">
                        <p class="green" style="width: 50%;"></p>
            ...
            <tr>
            <td class="project"><p class="name her">不认真做笔记</p></td>
                <td>
                    <span class="green">5</span>
                    <div  class="schedule">
                        <p class="green" style="width: 50%;"></p>
            ...
            <tr>
            <td class="project"><p class="name her">作业质量差</p></td>
                <td>
                    <span class="green">5</span>
                    <div  class="schedule">
                        <p class="green" style="width: 50%;"></p>
            ...
            <tr>
            <td class="project"><p class="name her">课堂作业未完成</p></td>
                <td>
                    <span class="green">5</span>
                    <div  class="schedule">
                        <p class="green" style="width: 50%;"></p>
