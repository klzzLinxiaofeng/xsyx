	...
	<jsp:include page="/views/embedded/navigation.jsp">
			...
			<div class="span12"  style="height: 43px;">
				<div class="content-widgets white" style="margin-bottom: 0;">
					<div class="widget-head">
						<h3>
							<span>新建校历</span>
							<span style="padding-left:20px;">选择：<select style="margin-bottom:0"><option>xx学校2014-2015学年下学期校历</option><option>xx学校2014-2015学年下学期校历</option><option>xx学校2014-2015学年下学期校历</option></select></span>
		...
		<div class="row-fluid">
			<div class="calculator">
				<div class="cal_top">
					<div class="cal_1">
						<p>XX学校2014-2015学年下学期校历</p>
						<p>本学期时间段：2015年3月1日-2015年7月18日</p>
					</div>
					<div class="cal_2">
						<button class="btn btn-blue">编辑</button>
						<button class="btn btn-danger">移出</button>
					</div>
				</div>
				<div class="cal_main">
					<table class="table responsive table-bordered">
						<thead>
						<tr><th >周序</th><th  >月份</th><th>一</th><th>二</th><th>三</th><th>四</th><th>五</th><th>六</th><th>七</th><th style="width:286px;">备注</th></tr>
						</thead>
					</table>
					<div class="white">
					...
					<div class="yue">
						...
						<div class="jiaqi">
							<p>清明节：5日、6日放假</p><p>劳动节：1日、2日、3日放假</p><p>端午节：20日 21日、22日放假</p>
						</div>
						<div class="clear"></div>
					</div>
				</div>
