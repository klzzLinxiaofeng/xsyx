		...
		<div class="row-fluid">
			<div class="span12">
				<div class="content-widgets white" >
					<div class="weike_top">
						<p><span>首页</span><span class="s2">分类资源</span><span>我的资源</span></p>
						<div class="gjz_select"><input type="text" style="width:200px;" placeholder="请输入资源关键词" value="教学"><button class="btn btn-primary">搜索</button><a href="javascript:void(0)" class="upload"><i class="fa fa-plus"></i> &nbsp; 上传资源</a></div>
						<div class="clear"></div>
					</div>
									...
									<div class="rs_platformContainer_1">
										<div class="main" style="margin-left:-1px;">
											...
											<div class="zy_list">
												...
												<div class="xkzy_list" style="display:none">
													<dl>
															...
															<div class="item-msg">
																<div class="item-title">
																	...
																	<span style="overflow:hidden;width:338px;float:left;display:block; white-space:nowrap; text-overflow:ellipsis; word-wrap: normal;">
																		<a href="javascript:void(0)" target="_blank">《a o e i u ü》<span style="color:#FF7E7E">教学</span>动画</a>
																	</span>
																</div>
