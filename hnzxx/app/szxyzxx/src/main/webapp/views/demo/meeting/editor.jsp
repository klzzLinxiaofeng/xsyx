				...
				<div class="widget-container" style="padding:20px 0 0;">
					<form class="form-horizontal" id="user_form">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="name" name="name" class="span4" placeholder="请输入会议名称 不能为空" value="讨论课">
                            </div>
						</div>
						<div class="control-group">
...
<script type="text/javascript">
	...
	function saveOrUpdate($this) {
		if (checker.form()) {
			...
			if($ifm.length > 0) {
				var ifm = $ifm.get(0);
				ifm.contentWindow.saveOrUpdateTd("update", name, start_date, end_date);
			}
		}
	}
