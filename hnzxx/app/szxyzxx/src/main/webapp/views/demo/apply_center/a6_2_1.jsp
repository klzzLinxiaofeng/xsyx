...
<div class="container-fluid">
	...
	<div class="content_main white">
		...
		<div class="apply_detail">
			...
			<div class="cz_btn fr">
				<button class="btn btn-orange apply_cxsj">重新上架</button>
			</div>
			<div class="jianjie">
				<p class="p2"><strong>办公OA</strong><span class="banben">版本：1.0</span><span class="qk yxj_red">已下架</span></p>
