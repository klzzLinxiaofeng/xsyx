...
<div class="kwgl">
	...
	<div class="pd20">
		...
		<div class="person_info" style="padding-bottom: 50px;">
			...
			<p class="p2">总体情况</p>
				...
				<table class="table table-striped" style="border:1px solid #e4e8eb;">
					<thead><tr><th>语文</th><th>本班</th></tr></thead>
					<tbody>
						<tr><td>你的分数</td><td>900</td></tr>
						<tr><td>你的名次</td><td>900</td></tr>
						<tr><td>均分</td><td>900</td></tr>
						<tr><td>均分名次</td><td>900</td></tr>
					</tbody>
				</table>
			</div>
		</div>
		...
		<div class="kwgl_main">
			...
			<div id="container4" style="min-width: 400px; height: 700px; max-width: 920px; margin: 0 auto"></div>
		</div>
		<div class="kwgl_main">
			<p class="title">班内名次趋势</p>
			<div id="container5" style="min-width: 400px; height: 700px; max-width: 920px; margin: 0 auto"></div>
		</div>
	</div>
</div>
</body>
...
$('#container1').highcharts({
 ...
 $('#container2').highcharts({
     ...
     tooltip: {
         shared: true,
         headerFormat: '',
         pointFormat: '<span style="font-size:20px;color:{series.color}">{series.name}: <b style="font-size:20px">{point.y}</b>分<br/>',
         useHTML: true
         // enabled:false
     },
     plotOptions: {
