				...
				<div class="content-widgets white">
					...
					<div class="yc_sq">
						<form class="form-horizontal" action="javascript:void(0);">
							...
							<div class="control-group">
								<label class="control-label">有无代课：</label>
								<div class="controls" style="padding-top:5px;">
									<input type="radio" name="daike" />有
									<input type="radio" name="daike" />无
								</div>
							</div>
							<div class="control-group">
								...
								<div class="d2" style="display:none"><ul></ul><a href="javascript:void(0)">添加</a></div>
