			...
			<div class="content-widgets white">
				...
				<div class="x-main">
					...
					<div class="clearfix x-mright">
						...
						<div class="clearfix">
							<p><span class="left"><i class="fa fa-comment-o"></i>备注</span></p>
							<div class="controls left">
								<textarea rows="3" class="span6"></textarea>
								<div class="fileupload fileupload-new clearfix" data-provides="fileupload"><input type="hidden">
									<div class="left">
										<span class="btn btn-file"><span class="fileupload-new"><i class="fa fa-upload"></i>上传图片</span>
										<input type="file"></span>
									</div>
								</div>
								<button class="btn btn-primary btn-main" type="button">提交评价</button>
							</div>
						</div>
