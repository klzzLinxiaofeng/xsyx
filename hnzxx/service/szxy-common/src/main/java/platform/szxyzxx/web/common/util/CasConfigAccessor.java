 ...
 * @Date 2014年9月26日
 */
public class CasConfigAccessor {
	private static Properties casProps = new Properties();
	private static final String CAS_FILE = "shiro.properties";

	static {
		InputStream inStream = null;
		try {
			inStream = CasConfigAccessor.class.getClassLoader().getResourceAsStream(CAS_FILE);
