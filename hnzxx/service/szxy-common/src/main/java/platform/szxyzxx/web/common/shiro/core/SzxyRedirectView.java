package platform.szxyzxx.web.common.shiro.core;
...
public class SzxyRedirectView {
     ...
     * @see #SzxyRedirectView(String, boolean)
     */
    public SzxyRedirectView(String url) {
        setUrl(url);
    }
     ...
     */
    public SzxyRedirectView(String url, boolean contextRelative) {
        this(url);
     ...
     */
    public SzxyRedirectView(String url, boolean contextRelative, boolean http10Compatible) {
        this(url);
        this.contextRelative = contextRelative;
